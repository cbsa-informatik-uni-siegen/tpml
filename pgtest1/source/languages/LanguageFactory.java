...
public final class LanguageFactory {
   ...
   * 
   * @param id the unique identifier of the {@link Language} to return,
   *           for example <code>"l1"</code>.
   * 
   * @throws NoSuchLanguageException if the <code>id</code> does not
   *                                 refer to a valid language.
   */
