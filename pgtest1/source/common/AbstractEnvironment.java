...
/**
 * Abstract implementation of the generic <code>Environment</code>
 * interface.
 *
...
public abstract class AbstractEnvironment<S, E> implements Environment<S, E> {
  ...
  /**
   * The mappings, the symbol/entry pairs, within
   * this environment.
   */
  ...
  /**
   * Default constructor, creates a new empty environment
   * with no mappings.
   */
  ...
  /**
   * Creates a new environment, based on the mappings from the
   * specified <code>environment</code>.
   * 
   * @param environment another <code>AbstractEnvironment</code>
   *                    to inherit the mappings from.
   *                    
   * @throws NullPointerException if the <code>environment</code>
   *                              is <code>null</code>.                    
   */
