...
/**
 * This exception is thrown whenever the users tries to invoke
 * the {@link common.ProofModel#redo()} method, but the change
 * cannot be redone or the redo history is empty.
 *
 * @author Benedikt Meurer
 * @version $Id$
 * 
 * @see common.CannotUndoException
 */
public final class CannotRedoException extends Exception {
  ...
  /**
   * Allocates a new <code>CannotRedoException</code> with the
