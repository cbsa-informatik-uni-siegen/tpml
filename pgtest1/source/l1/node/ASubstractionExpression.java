...
public final class ASubstractionExpression extends PExpression
{
    private PExpression _e0_;
    private PExpression _e1_;

    public ASubstractionExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ASubstractionExpression(
    ...
    {
        ((Analysis) sw).caseASubstractionExpression(this);
    }
