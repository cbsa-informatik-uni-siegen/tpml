...
public final class AModulationExpression extends PExpression
{
    private PExpression _e0_;
    private PExpression _e1_;

    public AModulationExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AModulationExpression(
    ...
    {
        ((Analysis) sw).caseAModulationExpression(this);
    }
