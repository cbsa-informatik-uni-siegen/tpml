...
public final class ARecursionExpression extends PExpression
{
    private TIdentifier _id_;
    private PExpression _e_;

    public ARecursionExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ARecursionExpression(
    ...
    {
        ((Analysis) sw).caseARecursionExpression(this);
    }
