...
import de.unisiegen.tpml.ui.EditorPanelUnify;
...
public class MainWindowForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        latexExportButton.setToolTipText(java.util.ResourceBundle.getBundle("de/unisiegen/tpml/ui/ui").getString("LatexToolTip"));
        ...
        printButton.setToolTipText(java.util.ResourceBundle.getBundle("de/unisiegen/tpml/ui/ui").getString("PdfToolTip"));
        ...
        unificationItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F8, 0));
        unificationItem.setMnemonic(java.util.ResourceBundle.getBundle("de/unisiegen/tpml/ui/ui").getString("unificationMnemonic").charAt(0));
        unificationItem.setText(java.util.ResourceBundle.getBundle("de/unisiegen/tpml/ui/ui").getString("Unification"));
        unificationItem.setName("unificationItem");
        unificationItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                unificationItemActionPerformed(evt);
            }
        });
    ...
    private void bigstepclosureItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bigstepclosureItemActionPerformed
      ( ( EditorPanelExpression ) logic.getActiveEditor ( ) ).handleBigStepClosure();
    }//GEN-LAST:event_bigstepclosureItemActionPerformed

    private void unificationItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unificationItemActionPerformed
      ((EditorPanelUnify)logic.getActiveEditor ()).handleUnify ();
    }//GEN-LAST:event_unificationItemActionPerformed
...
// TODO add your handling code here:
    ...
    public javax.swing.JMenuItem bigstepclosureItem;
    ...
    public javax.swing.JMenuItem unificationItem;
