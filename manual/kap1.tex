...
ersten Start von {\tt tpml.sh} wird das Programm im System registriert, das heisst im Men"u erscheint
...
w"ahlen wir also auch hier ein einfaches Programmbeispiel in der Programmiersprache \LZERO. Die Sprachen sind in Kategorien unterteilt, \LZERO ist natürlich in der ersten zu ganz oben zu finden. 
...
ist. Die anderen Beweisemethoden, die alle auf das Typsystem abzielen sind bei \LZERO logischerweise nicht sinnvoll. F"ur das Beispiel benutzen wir den small step Interpreter. Dazu w"ahlt man aus dem
