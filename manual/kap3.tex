...
partielle Funktion mit endlichem Definitionsbereich ist, die bestimmten Bezeichnern \mbox einen Typ zuordnet. $\Gamma$ wird
...
\end{tabular}\\[7mm]
definiert. Beim Type Checker werden diese Regeln f"ur Konstanten nicht angegeben, sondern \mbox lediglich die (CONST) Regel.
...
sondern \mbox es wird implizit eine Konvertierung des betreffenden Teilausdrucks in \notation{Kernsyntax} vorgenommen. F"ur \LONE\ betrifft dies
...
hinaus zu beachten, dass Operatoren, sofern \mbox sie nicht in Infixausdr"ucken auftauchen, immer geklammert werden m"ussen. Die
...
(CONS) Regel\footnote{Der Leser wird sich hoffentlich erinnern \mbox, dass bin"are Operatoren, die au"serhalb eines Infixausdrucks
...
Schl"usselw"ortern \mbox unterschieden werden.\\[5mm]
\begin{tabular}{lll}
