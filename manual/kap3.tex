...
Ein \define{big step} ist eine Formel der Gestalt $e \eval v$ mit $v \in Val$. Ein big step hei"st g"ultig f"ur \LZERO, wenn
...
\omega \is \eps                                                     & & \mbox{leere Reihe}
  \al \attr {a}{v}\ \omega_1                                        & & \mbox{Attribut}
...
Ein \notation{Typurteil} hei"st g"ultig f"ur \LFOUR, wenn es sich mit den Typregeln von \LTHREE\ und den Regeln\\[3mm]
\begin{tabular}{ll}
