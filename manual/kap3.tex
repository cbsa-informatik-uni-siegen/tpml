...
\begin{tabular}{lll}
  ...
  \mbox{$a: \tau;\ \phi$}                   & $\texttt{attr}\ a: \tau;\ \phi \quad$    & Reihentypen\\
\end{tabular}\\[5mm]
Zu beachten ist auch, dass der Scanner den Ausdruck \glqq{\bf (*) 4 5}\grqq\ nicht akzeptiert,
da Kommentare mit einem \glqq{\bf (*}\grqq\ eingeleitet werden. Er erwartet ein \glqq{\bf *)}\grqq,
um den Kommentar zu beenden. Wenn multipliziert werden soll, muss \glqq{\bf ( *) 4 5}\grqq\ eingeben werden.
