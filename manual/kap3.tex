...
Gr"unden der "Ubersichtlichkeit nicht immer abgeleitete Regeln f"ur den syntaktischen Zucker eingef"uhrt, sondern es wird implizit
eine Konvertierung des betreffenden Teilausdrucks in Kernsyntax vorgenommen. F"ur \LONE\ betrifft dies Ausdr"ucke, die
Operatoren in Infixschreibweise enthalten, und die logischen Operatoren $\mathbin{\&\&}$ und $\mathbin{||}$. Es gilt:
\beqns
...
Ein big step hei"st g"ultig f"ur \LTWO, wenn er sich mit den big step Regeln von \LONE\ und der Regel\\[3mm]
  \begin{tabular}{ll}
...
Ein small step hei"st g"ultig f"ur \LTWO, wenn er sich mit den small step Regeln von \LONE\ und der Regel\\[3mm]
  \begin{tabular}{ll}
...
Ein Typurteil hei"st g"ultig f"ur \LTWO, wenn es sich mit den Typregeln von \LONE\ und der Regel\\[3mm]
\begin{tabular}{ll}
...
\end{eqnarray*}
Um die Typsicherheit zu gew"ahrleisten, muss die Regel (P-LET) eingeschr"ankt werden, und zwar wird nun
...
Die Sprache \LFOUR\ beinhaltet drei Abk"urzungen, die wie folgt in Kernsyntax "ubersetzt werden
\begin{eqnarray*}
