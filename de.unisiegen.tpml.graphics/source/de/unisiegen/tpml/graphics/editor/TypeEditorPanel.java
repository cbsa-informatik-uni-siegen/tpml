  ...
  public void handleCut ()
  {
    ...
    try
    {
      if ( this.editor.equals ( this.editor1 ) )
      {
        ...
        setRedoStatus ( false );
        this.redohistory.clear ();
        this.currentContent1 = this.sourceField1.getText ( 0, this.sourceField1
            .getLength () );
        removeSelectedText ();
      }
      else if ( this.editor.equals ( this.editor2 ) )
      {
        ...
        setRedoStatus ( false );
        this.redohistory2.clear ();
        this.currentContent2 = this.sourceField2.getText ( 0, this.sourceField2
            .getLength () );
        removeSelectedText2 ();
      }
      else
  ...
  private class OwnDocumentListener implements DocumentListener
  {
    ...
    public void removeUpdate ( DocumentEvent arg0 )
    {
      try
      {
        ...
        setRedoStatus ( false );
        TypeEditorPanel.this.redohistory.clear ();
        TypeEditorPanel.this.currentContent1 = arg0.getDocument ().getText ( 0,
            arg0.getDocument ().getLength () );
        setUndoStatus ( true );
      }
      catch ( BadLocationException e )
  ...
  private class OwnDocumentListener2 implements DocumentListener
  {
    ...
    public void removeUpdate ( DocumentEvent arg0 )
    {
      try
      {
        ...
        setRedoStatus ( false );
        TypeEditorPanel.this.redohistory2.clear ();
        TypeEditorPanel.this.currentContent2 = arg0.getDocument ().getText ( 0,
            arg0.getDocument ().getLength () );
        setUndoStatus ( true );
      }
      catch ( BadLocationException e )
