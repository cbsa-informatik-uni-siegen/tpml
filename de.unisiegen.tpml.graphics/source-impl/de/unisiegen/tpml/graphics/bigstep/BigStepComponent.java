    ...
    Scrollable, Cloneable
{
  ...
  private void checkForUserObject ( BigStepProofNode node )
  {
    ...
    if ( nodeComponent == null )
    {
      ...
      nodeComponent = new BigStepNodeComponent ( node,
          ( BigStepProofModel ) this.proofModel, this.translator );
  ...
  {
    BigStepProofNode rootNode = ( BigStepProofNode ) BigStepComponent.this
        .getProofModel ().getRoot ();

    Point rightBottomPos = BigStepComponent.this.getTreeNodeLayout ()
        .placeNodes ( rootNode, BigStepComponent.this.getThisBorder (),
            BigStepComponent.this.getThisBorder (),
            BigStepComponent.this.getAvailableWidth (),
            BigStepComponent.this.getAvailableHeight () );
