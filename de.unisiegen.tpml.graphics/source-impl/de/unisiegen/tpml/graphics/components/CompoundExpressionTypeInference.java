...
public class CompoundExpressionTypeInference extends JComponent
{
      ...
      public void mouseDragged ( MouseEvent event )
      {
        if ( CompoundExpressionTypeInference.this.isDragndropeabled () )
        {
          ...
          if ( CompoundExpressionTypeInference.this.dragged )
          {
            ...
            CompoundExpressionTypeInference.this
  ...
  protected void handelMouseReleased ( MouseEvent event )
  {
    ...
    if ( isDragndropeabled () && CompoundExpressionTypeInference.this.dragged
        && ( this.rectPressed != this.rectReleased )
        && ( this.rectPressed != -1 ) && ( this.rectReleased != -1 ) )
    {
      CompoundExpressionTypeInference.this.typeFormularRenderer.draggNDropp (
  ...
  protected void handelMousePressed ( MouseEvent event )
  {
    if ( isDragndropeabled () )
    {
      ...
      ArrayList < Rectangle > rects = CompoundExpressionTypeInference.this.typeFormularRenderer
          .getTypeFormularPositions ();
      for ( int i = 0 ; i < rects.size () ; i++ )
      {
        if ( isIn ( rects.get ( i ), mousePressedPosition ) )
        {
          ...
          CompoundExpressionTypeInference.this.draggedString = CompoundExpressionTypeInference.this.typeFormulaList
              .get ( i ).toString ();
   ...
   * {@link CompoundExpressionTypeInference} provides the positions of the
  ...
  protected void handelMouseClicked ( MouseEvent pMouseEvent )
  {
    ...
    ArrayList < Rectangle > leftType = CompoundExpressionTypeInference.this.typeFormularRenderer
        .getLeftTypePositions ();
    ArrayList < Rectangle > rightType = CompoundExpressionTypeInference.this.typeFormularRenderer
        .getRightTypePositions ();
    ArrayList < Rectangle > expressionPositions = CompoundExpressionTypeInference.this.typeFormularRenderer
        .getExpressionPositions ();
    ArrayList < Rectangle > typePositions = CompoundExpressionTypeInference.this.typeFormularRenderer
        .getTypePositions ();
