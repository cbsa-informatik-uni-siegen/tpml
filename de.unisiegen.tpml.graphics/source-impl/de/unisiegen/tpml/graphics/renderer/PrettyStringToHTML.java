 ...
 * This is used by the {@link CompoundExpressionTypeInference} to provide the
 * tooltip of the A. This calss realy only translats the prettystring into html,
...
public class PrettyStringToHTML
{
  ...
  public static String toHTMLString ( PrettyString s )
  {
    ...
    for ( char c = it.setIndex ( charIndex ) ; c != CharacterIterator.DONE ; c = it
        .next () , charIndex++ )
    {
      // get the style
      switch ( it.getStyle () )
