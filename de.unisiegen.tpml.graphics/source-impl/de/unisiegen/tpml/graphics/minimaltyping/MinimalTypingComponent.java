...
/**
 * Implementation of the graphics repsentation of the MinimalTyping<br>
 * <br>
 ...
 * <br>
 * The nodes are not stored directly in the <i>MinimalTypingComponent</i>, they
 ...
 * called) the {@link #checkForUserObject(MinimalTypingProofNode)}-method is
 ...
 */
public class MinimalTypingComponent extends AbstractProofComponent implements
    Scrollable, Cloneable
{
  ...
  protected void doRelayout ()
  {
    ...
    Point rightBottomPos = MinimalTypingComponent.this.treeNodeLayout
        .placeNodes ( rootNode, 20, 20,
            MinimalTypingComponent.this.availableWidth,
            MinimalTypingComponent.this.availableHeight );
  ...
  /**
   * Checks the entire tree if every {@link MinimalTypingProofNode} contains an
   * Userobject.
   * 
   * @param node
   */
  private void checkForUserObject ( MinimalTypingProofNode node )
  {
    ...
    MinimalTypingNodeComponent nodeComponent = ( MinimalTypingNodeComponent ) node
        .getUserObject ();
    if ( nodeComponent == null )
    {
      ...
      nodeComponent = new MinimalTypingNodeComponent ( node,
          ( MinimalTypingProofModel ) this.proofModel, this.translator );
      ...
      nodeComponent
          .addMinimalTypingNodeListener ( new MinimalTypingNodeListener ()
          {
  ...
  protected void treeContentChanged ()
  {
    ...
    MinimalTypingProofNode rootNode = ( MinimalTypingProofNode ) this.proofModel
        .getRoot ();
  ...
  protected void nodesChanged ( TreeModelEvent event )
  {
    ...
    if ( children == null )
    {
      ...
      {
        MinimalTypingProofNode proofNode = ( MinimalTypingProofNode ) event
            .getPath () [ 0 ];
  ...
  private void jumpToNodeVisible ()
  {
    ...
    // on the viewport
    MinimalTypingNodeComponent node = ( MinimalTypingNodeComponent ) this.jumpNode
        .getUserObject ();
    if ( node == null )
    {
      return;
