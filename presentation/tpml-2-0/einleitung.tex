...
\myslide{Motivation I}{
  ...
  \animate{1}{
    \begin{itemgroup}{Gründe}
      ...
      \item Regelwerk durch \glqq praktisches Arbeiten\grqq\ besser zu verstehen.
...
\myslide{Projektgruppe TPML 2.0.0}{
    ...
    \item {\tt Weiterentwicklung der Kernkomponenten} - Christian Fehler, Benjamin Mies
    \item {\tt Visuelle Darstellung der Beweiswerkzeuge} - Michael Oeste
    \item {\tt Benutzerinterface und PDF Export} - Christoph Fehling
  \end{itemgroup}
}
