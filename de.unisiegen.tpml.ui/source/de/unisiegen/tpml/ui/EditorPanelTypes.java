...
public class EditorPanelTypes extends AbstractBean implements EditorPanel {
	...
	public EditorPanelTypes ( Language language, MainWindow window ) {
		...
		mypanel.codeButton.setPreferredSize ( new Dimension ( mypanel.codeButton.getPreferredSize ( ).width, mypanel.pongButton
				.getPreferredSize ( ).height ) );
		mypanel.subTypingButton.setPreferredSize ( new Dimension ( mypanel.subTypingButton.getPreferredSize ( ).width,
			mypanel.pongButton.getPreferredSize ( ).height ) );
		mypanel.subTypingRecButton.setPreferredSize ( new Dimension ( mypanel.subTypingRecButton.getPreferredSize ( ).width,
			mypanel.pongButton.getPreferredSize ( ).height ) );
	...
	public void handleSubTyping ( ) {
		...
		try {
			if ( this.getEditorType ( ) != null && this.getEditorType2 ( ) != null ) {
				...
				JOptionPane.showMessageDialog ( mypanel, java.util.ResourceBundle.getBundle ( "de/unisiegen/tpml/ui/ui" ) //$NON-NLS-1$
