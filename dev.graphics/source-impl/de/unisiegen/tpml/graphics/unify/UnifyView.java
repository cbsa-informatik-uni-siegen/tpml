 ...
 * interface for the unify interpreter user interface.
 * 
 * @author michael
 * @author Christian Fehler
 * @version $Id$
 * @see de.unisiegen.tpml.graphics.AbstractProofView
 * @see de.unisiegen.tpml.graphics.unify.UnifyComponent
 */
public class UnifyView extends AbstractProofView
{
   ...
   * TODO
   */
  private static final long serialVersionUID = 4480829479870314004L;
   ...
   */
  private UnifyComponent component;
   ...
   */
  private UnifyProofModel unifyProofModel;
  ...
  public UnifyView ( UnifyProofModel pTypeInferenceProofModel )
  {
    ...
    this.component = new UnifyComponent ( this.unifyProofModel,
        isAdvanced () );
    ...
    this.scrollPane.addComponentListener ( new ComponentAdapter ()
    {
      ...
      {
        UnifyView.this.component.setAvailableWidth ( UnifyView.this.scrollPane
   ...
   * @see #unifyProofModel
   */
  public UnifyProofModel getUnifyProofModel ()
  {
    return this.unifyProofModel;
  }
