...
/**
 * Base interface for the proof rules used within the big step interpreter. This
 * interface is very similar to the
 * {@link de.unisiegen.tpml.core.typechecker.TypeCheckerProofRule} used within
 * the type checker.
 * 
 * @author Benedikt Meurer
 * @version $Id:BigStepProofRule.java 2796 2008-03-14 19:13:11Z fehler $
