...
public final class LanguageFactory
{
  ...
  public Language [] getAvailableLanguages ()
  {
    ...
    { new L0Language (), new L0CBNLanguage (), new L1Language (),
        new L1SUBLanguage (), new L1CBNLanguage (), new L1UNIFYLanguage (),
        new L2Language (), new L2SUBLanguage (), new L2CBNLanguage (),
        new L2OLanguage (), new L2OSUBLanguage (), new L2CLanguage (),
        new L2CSUBLanguage (), new L3Language (), new L3SUBLanguage (),
        new L4Language (), new L4SUBLanguage () };
  }
