 ...
 * @version $Id: AbstractTypeCheckerProofRuleSet.java 2796 2008-03-14 19:13:11Z fehler $
 * @see de.unisiegen.tpml.core.AbstractProofRuleSet
 */
public abstract class AbstractTypeCheckerProofRuleSet extends
    AbstractProofRuleSet
{
  ...
  /**
   * Allocates a new <code>AbstractTypeCheckerProofRuleSet</code> for the
   * specified <code>language</code>.
   * 
   * @param language the {@link Language} to which the type checker proof rules
   *          in this set belong.
      ...
      final Method updateMethod )
  {
    ...
    register ( new AbstractTypeCheckerProofRule ( group, name )
    {
      ...
      {
        applyMethod.invoke ( AbstractTypeCheckerProofRuleSet.this, context,
            node );
      }
          ...
          TypeCheckerProofNode node ) throws Exception
      {
        ...
        {
          updateMethod.invoke ( AbstractTypeCheckerProofRuleSet.this, context,
              node );
        }
      }
    } );
