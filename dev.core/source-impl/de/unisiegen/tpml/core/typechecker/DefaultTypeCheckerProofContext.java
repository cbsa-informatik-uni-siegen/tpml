 ...
 * @version $Id: DefaultTypeCheckerProofContext.java 2829 2008-04-24 14:15:22Z mies $
...
public class DefaultTypeCheckerProofContext implements TypeCheckerProofContext
{
   ...
   * @see TypeEquation
   */
  private TypeEquationList equations = new DefaultTypeEquationList();//.EMPTY_LIST;
   ...
   *      de.unisiegen.tpml.core.types.MonoType)
   */
  public void addProofNode ( TypeCheckerProofNode node, MonoType type,
      MonoType type2 )
  {
    this.model.contextAddProofNode ( this,
