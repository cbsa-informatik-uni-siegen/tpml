 ...
 * @version $Id: DefaultTypeSubstitution.java 2796 2008-03-14 19:13:11Z fehler $
...
public final class DefaultTypeSubstitution implements TypeSubstitution
{
      ...
      LatexStringBuilderFactory pLatexStringBuilderFactory, int pIndent )
  {
    LatexStringBuilder builder = pLatexStringBuilderFactory.newBuilder ( 0,
        LATEX_TYPE_SUBSTITUTION, pIndent, this.toPrettyString ().toString (),
        this.type.toPrettyString ().toString (), this.tvar.toPrettyString ()
            .toString () );
   ...
   * {@inheritDoc}
   * 
   * @see de.unisiegen.tpml.core.typechecker.TypeSubstitution#getTvar()
   */
