...
/**
 * Default implementation of the <code>TypeCheckerProofNode</code> interface.
 * The class for nodes in a
 * {@link de.unisiegen.tpml.core.typechecker.TypeCheckerProofModel}.
 * 
 * @author Benedikt Meurer
 * @version $Id: AbstractTypeCheckerProofNode.java 2796 2008-03-14 19:13:11Z fehler $
 * @see de.unisiegen.tpml.core.AbstractExpressionProofNode
 * @see de.unisiegen.tpml.core.typechecker.TypeCheckerProofNode
 */
public abstract class AbstractTypeCheckerProofNode extends
    AbstractExpressionProofNode implements TypeCheckerProofNode
{
  ...
  /**
   * Allocates a new <code>DefaultTypeCheckerProofNode</code> with the
   * specified <code>environment</code>, <code>expression</code> and
   * <code>type</code>.
   * 
   ...
   * builder.append(this.environment); builder.append(" \u22b3 "); //$NON-NLS-1$
   * builder.append(this.expression); builder.append(" :: "); //$NON-NLS-1$
   * builder.append(this.type); if (getRule() != null) { builder.append(" (" +
   * getRule() + ")"); //$NON-NLS-1$//$NON-NLS-2$ } return builder.toString(); }
   */
}
