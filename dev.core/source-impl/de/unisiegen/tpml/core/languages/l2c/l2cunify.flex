...
/**
 * This is the type scanner class for L2CUNIFY.
 */
%%

%class L2CUnifyScanner
%extends AbstractLanguageUnifyScanner
%implements L2CUnifyTerminals
...
<YYINITIAL>
{
	...
	"zeta"|"\u03b6"		{ return symbol("ZETA", ZETA); }
