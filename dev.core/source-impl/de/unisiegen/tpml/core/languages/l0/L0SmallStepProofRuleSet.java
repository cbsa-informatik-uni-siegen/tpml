 ...
 * @version $Id:L0SmallStepProofRuleSet.java 2796 2008-03-14 19:13:11Z fehler $
 * @see Language
...
public class L0SmallStepProofRuleSet extends AbstractSmallStepProofRuleSet
{
  ...
  /**
   * Similar in its nature to the
   * {@link AbstractSmallStepProofRuleSet#evaluate(SmallStepProofContext, Expression)}
   * method, but is used to evaluate applications. This method determines the
   * class of the <code>e1</code> (i.e. <tt>Lambda</tt> for lambda
   * abstractions) and then looks for a method named <tt>applyClass</tt> (i.e.
   * <tt>applyLambda</tt> for lambda abstractions). The method is passed the
   * <code>context</code>, the <code>application</code>, <code>e1</code>
   * and <code>e2</code>. If no such method exists, a method for the parent
   * class of the <code>application</code> will be search and so on. If no
   * method is found, the <code>application</code> will be returned and
   * <code>context</code> will not be modified.
   * 
