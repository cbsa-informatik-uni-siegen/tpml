 ...
 * @version $Id: AbstractTypeCheckerProofRuleSet.java 2796 2008-03-14 19:13:11Z
 *          fehler $
 * @see de.unisiegen.tpml.core.AbstractProofRuleSet
 */
public abstract class AbstractUnifyProofRuleSet extends AbstractProofRuleSet
{
  ...
  /**
   * Allocates a new <code>AbstractUnifyProofRuleSet</code> for the specified
   * <code>language</code>.
   * 
   ...
   *           <code>null</code>.
   */
  protected AbstractUnifyProofRuleSet ( Language language )
  {
    super ( language );
  }
