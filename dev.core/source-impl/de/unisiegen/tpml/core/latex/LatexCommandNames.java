 ...
 * @version $Id: LatexCommandNames.java 2796 2008-03-14 19:13:11Z fehler $
 * @see LatexPrintable
 */
public interface LatexCommandNames
{
  ...
  /**
   * The latex print command for {@link DefaultBigStepClosureProofNode}.
   */
  public static final String LATEX_BIG_STEP_CLOSURE_PROOF_NODE = "BigStepClosureProofNode"; //$NON-NLS-1$
  ...
  /**
   * The latex print command for {@link BigStepClosureProofResult}.
   */
  public static final String LATEX_BIG_STEP_CLOSURE_PROOF_RESULT = "BigStepClosureProofResult"; //$NON-NLS-1$
  ...
  /**
   * The latex print command for {@link BigStepClosureProofModel}.
   */
  public static final String LATEX_BIG_STEP_CLOSURE_RPOOF_MODEL = "BigStepClosureProofModel"; //$NON-NLS-1$
  ...
  /**
   * The latex print command for {@link BigStepClosureProofRule}.
   */
  public static final String LATEX_BIG_STEP_CLOSURE_PROOF_RULE = "BigStepClosureProofRule"; //$NON-NLS-1$


  /**
   * The latex print command for {@link Closure}.
   */
  public static final String LATEX_CLOSURE = "closure"; //$NON-NLS-1$
