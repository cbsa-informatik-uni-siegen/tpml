...
public class ParserTest
{
  ...
  private static String MULTI_LAMBDA_ERROR_36 = "lambda (,y).x + y";


  private static String MULTI_LAMBDA_ERROR_37 = "lambda (,y,z).x + y";


  private static String MULTI_LAMBDA_ERROR_38 = "lambda (,y):int.x + y";


  private static String MULTI_LAMBDA_ERROR_39 = "lambda (,y,z):int.x + y";
  ...
  private static String MULTI_LET_ERROR_75 = "let (,y) = (1,2) in x+y";


  private static String MULTI_LET_ERROR_76 = "let (,y,z) = (1,2) in x+y";


  private static String MULTI_LET_ERROR_77 = "let (,y):int = (1,2) in x+y";


  private static String MULTI_LET_ERROR_78 = "let (,y,z):int = (1,2) in x+y";
  ...
  private static String TUPLE_ERROR_6 = "(,2)";


  private static String TUPLE_ERROR_7 = "(,2,3)";
  ...
  private static String LIST_ERROR_6 = "[;2]";


  private static String LIST_ERROR_7 = "[;2;3]";
  ...
  private static String CLASS_2 = "class (self:<>) end";


  private static String CLASS_3 = "class (self) method m = 0 ; end";


  private static String CLASS_4 = "class (self:<>) method m = 0 ; end";


  private static String CLASS_5 = "class (self) inherit a, b from e ; method add = 0 ; end";


  private static String CLASS_6 = "class (self:<>) inherit a, b from e ; method add = 0 ; end";


  private static String CLASS_ERROR_1 = "class (self) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_2 = "class (self:<>) inherit a, b from e ; method add = 0 ;";
  ...
  private static String CLASS_ERROR_5 = "class self:<>";


  private static String CLASS_ERROR_6 = "class self:<>)";


  private static String CLASS_ERROR_7 = "class self:<>) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_8 = "class self:<>) inherit a, b from e ; method add = 0 ; end";


  // self
  private static String CLASS_ERROR_9 = "class (:";


  private static String CLASS_ERROR_10 = "class (:<>";


  private static String CLASS_ERROR_11 = "class (:<>)";


  private static String CLASS_ERROR_12 = "class (:<>) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_13 = "class (:<>) inherit a, b from e ; method add = 0 ; end";


  private static String CLASS_ERROR_14 = "class ( )";


  private static String CLASS_ERROR_15 = "class ( ) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_16 = "class ( ) inherit a, b from e ; method add = 0 ; end";


  // right bracket
  private static String CLASS_ERROR_17 = "class (self end";


  private static String CLASS_ERROR_18 = "class (self inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_19 = "class (self inherit a, b from e ; method add = 0 ; end";


  private static String CLASS_ERROR_20 = "class (self:<> end";


  private static String CLASS_ERROR_21 = "class (self:<> inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_22 = "class (self:<> inherit a, b from e ; method add = 0 ; end";


  // colon
  private static String CLASS_ERROR_23 = "class (self <>";


  private static String CLASS_ERROR_24 = "class (self <>)";


  private static String CLASS_ERROR_25 = "class (self <>) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_26 = "class (self <>) inherit a, b from e ; method add = 0 ; end";


  // type
  private static String CLASS_ERROR_27 = "class (self: )";


  private static String CLASS_ERROR_28 = "class (self: ) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_29 = "class (self: ) inherit a, b from e ; method add = 0 ; end";


  // left paren and self
  private static String CLASS_ERROR_30 = "class )";


  private static String CLASS_ERROR_31 = "class ) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_32 = "class ) inherit a, b from e ; method add = 0 ; end";


  private static String CLASS_ERROR_33 = "class :";


  private static String CLASS_ERROR_34 = "class :<>";


  private static String CLASS_ERROR_35 = "class :<>)";


  private static String CLASS_ERROR_36 = "class :<>) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_37 = "class :<>) inherit a, b from e ; method add = 0 ; end";


  // self and right paren
  private static String CLASS_ERROR_38 = "class ( end";


  private static String CLASS_ERROR_39 = "class ( inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_40 = "class ( inherit a, b from e ; method add = 0 ; end";


  // self and colon
  private static String CLASS_ERROR_41 = "class ( <>";


  private static String CLASS_ERROR_42 = "class ( <>)";


  private static String CLASS_ERROR_43 = "class ( <>) inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_44 = "class ( <>) inherit a, b from e ; method add = 0 ; end";


  // type and right paren
  private static String CLASS_ERROR_45 = "class (self: end";


  private static String CLASS_ERROR_46 = "class (self: inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_47 = "class (self: inherit a, b from e ; method add = 0 ; end";


  // left paren, self and right paren
  private static String CLASS_ERROR_48 = "class end";


  private static String CLASS_ERROR_49 = "class inherit a, b from e ; method add = 0 ;";


  private static String CLASS_ERROR_50 = "class inherit a, b from e ; method add = 0 ; end";


  // left paren, self and colon
  private static String CLASS_ERROR_51 = "class <>";


  private static String CLASS_ERROR_52 = "class <>)";


  private static String CLASS_ERROR_53 = "class <>) inherit a, b from e ; method add = 0 ;";
  ...
  { LAMBDA_ERROR_1, LAMBDA_ERROR_2, LAMBDA_ERROR_3, LAMBDA_ERROR_7,
      LAMBDA_ERROR_8, LAMBDA_ERROR_13, SIMPLE_EXPR_ERROR_1, SIMPLE_EXPR_ERROR_2 };
  ...
  { IDENTIFIER, APPLICATION, INFIX_OPERATION_1, INFIX_OPERATION_2,
      ...
      OPERATOR_7, OPERATOR_8, OPERATOR_9, OPERATOR_10, SIMPLE_EXPR_1,
      SIMPLE_EXPR_2, EXPR_SIMPLE_TYPE, EXPR_BOOLEAN_TYPE, EXPR_INTEGER_TYPE,
      EXPR_UNIT_TYPE, EXPR_ARROW_TYPE, EXPR_TYPE_VARIABLE };


  private static String [] L1_ERROR = new String []
  { INFIX_OPERATION_ERROR_1, INFIX_OPERATION_ERROR_2, INFIX_OPERATION_ERROR_3,
      INFIX_OPERATION_ERROR_4, INFIX_OPERATION_ERROR_5,
      INFIX_OPERATION_ERROR_6, INFIX_OPERATION_ERROR_7,
      INFIX_OPERATION_ERROR_8, INFIX_OPERATION_ERROR_9,
      INFIX_OPERATION_ERROR_10, AND_ERROR, OR_ERROR, CONDITION_ERROR_1,
      CONDITION_ERROR_2, CONDITION_ERROR_3, CONDITION_ERROR_4,
      ...
      CONDITION_ERROR_14, CONDITION_ERROR_15, LAMBDA_ERROR_1, LAMBDA_ERROR_2,
      LAMBDA_ERROR_3, LAMBDA_ERROR_4, LAMBDA_ERROR_5, LAMBDA_ERROR_6,
      LAMBDA_ERROR_7, LAMBDA_ERROR_8, LAMBDA_ERROR_9, LAMBDA_ERROR_10,
      LAMBDA_ERROR_11, LAMBDA_ERROR_12, LAMBDA_ERROR_13, LAMBDA_ERROR_14,
      LAMBDA_ERROR_15, LAMBDA_ERROR_16, LAMBDA_ERROR_17, LAMBDA_ERROR_18,
      LAMBDA_ERROR_19, LAMBDA_ERROR_20, LAMBDA_ERROR_21, LAMBDA_ERROR_22,
      LAMBDA_ERROR_23, LET_ERROR_1, LET_ERROR_2, LET_ERROR_3, LET_ERROR_4,
      LET_ERROR_5, LET_ERROR_6, LET_ERROR_7, LET_ERROR_8, LET_ERROR_9,
      LET_ERROR_10, LET_ERROR_11, LET_ERROR_12, LET_ERROR_13, LET_ERROR_14,
      LET_ERROR_15, LET_ERROR_16, LET_ERROR_17, LET_ERROR_18, LET_ERROR_19,
      LET_ERROR_20, LET_ERROR_21, LET_ERROR_22, LET_ERROR_23, LET_ERROR_24,
      LET_ERROR_25, LET_ERROR_26, LET_ERROR_27, LET_ERROR_28, LET_ERROR_29,
      LET_ERROR_30, LET_ERROR_31, LET_ERROR_32, LET_ERROR_33, LET_ERROR_34,
      LET_ERROR_35, LET_ERROR_36, LET_ERROR_37, LET_ERROR_38, LET_ERROR_39,
      LET_ERROR_40, LET_ERROR_41, LET_ERROR_42, LET_ERROR_43, LET_ERROR_44,
      LET_ERROR_45, LET_ERROR_46, LET_ERROR_47, LET_ERROR_48, LET_ERROR_49,
      LET_ERROR_50, LET_ERROR_51, LET_ERROR_52, CURRIED_LET_ERROR_1,
      CURRIED_LET_ERROR_2, CURRIED_LET_ERROR_3, CURRIED_LET_ERROR_4,
      CURRIED_LET_ERROR_5, CURRIED_LET_ERROR_6, CURRIED_LET_ERROR_7,
      CURRIED_LET_ERROR_8, CURRIED_LET_ERROR_9, CURRIED_LET_ERROR_10,
      CURRIED_LET_ERROR_11, CURRIED_LET_ERROR_12, CURRIED_LET_ERROR_13,
      CURRIED_LET_ERROR_14, CURRIED_LET_ERROR_15, CURRIED_LET_ERROR_16,
      CURRIED_LET_ERROR_17, CURRIED_LET_ERROR_18, CURRIED_LET_ERROR_19,
      CURRIED_LET_ERROR_20, CURRIED_LET_ERROR_21, CURRIED_LET_ERROR_22,
      CURRIED_LET_ERROR_23, CURRIED_LET_ERROR_24, CURRIED_LET_ERROR_25,
      CURRIED_LET_ERROR_26, CURRIED_LET_ERROR_27, CURRIED_LET_ERROR_28,
      CURRIED_LET_ERROR_29, CURRIED_LET_ERROR_30, CURRIED_LET_ERROR_31,
      CURRIED_LET_ERROR_32, CURRIED_LET_ERROR_33, CURRIED_LET_ERROR_34,
      CURRIED_LET_ERROR_35, CURRIED_LET_ERROR_36, CURRIED_LET_ERROR_37,
      CURRIED_LET_ERROR_38, CURRIED_LET_ERROR_39, CURRIED_LET_ERROR_40,
      COERCION_ERROR_1, COERCION_ERROR_2, COERCION_ERROR_3, COERCION_ERROR_4,
      COERCION_ERROR_5, COERCION_ERROR_6, COERCION_ERROR_7, COERCION_ERROR_8,
      ...
      EXPR_SIMPLE_TYPE_ERROR_2, EXPR_ARROW_TYPE_ERROR };
  ...
  { IDENTIFIER, APPLICATION, INFIX_OPERATION_1, INFIX_OPERATION_2,
      ...
      OPERATOR_7, OPERATOR_8, OPERATOR_9, OPERATOR_10, SIMPLE_EXPR_1,
      SIMPLE_EXPR_2, EXPR_SIMPLE_TYPE, EXPR_BOOLEAN_TYPE, EXPR_INTEGER_TYPE,
      EXPR_UNIT_TYPE, EXPR_ARROW_TYPE, EXPR_TYPE_VARIABLE, REC_1, REC_2,
  ...
  { INFIX_OPERATION_ERROR_1, INFIX_OPERATION_ERROR_2, INFIX_OPERATION_ERROR_3,
      ...
      COERCION_ERROR_18, COERCION_ERROR_19, SIMPLE_EXPR_ERROR_1,
      SIMPLE_EXPR_ERROR_2, SIMPLE_EXPR_ERROR_3, EXPR_SIMPLE_TYPE_ERROR_1,
      EXPR_SIMPLE_TYPE_ERROR_2, EXPR_ARROW_TYPE_ERROR, REC_ERROR_1,
      ...
      LET_REC_ERROR_12, LET_REC_ERROR_13, LET_REC_ERROR_14, LET_REC_ERROR_15,
      LET_REC_ERROR_16, LET_REC_ERROR_17, LET_REC_ERROR_18, LET_REC_ERROR_19,
      LET_REC_ERROR_20, LET_REC_ERROR_21, LET_REC_ERROR_22, LET_REC_ERROR_23,
      LET_REC_ERROR_24, LET_REC_ERROR_25, LET_REC_ERROR_26, LET_REC_ERROR_27,
      LET_REC_ERROR_28, LET_REC_ERROR_29, LET_REC_ERROR_30, LET_REC_ERROR_31,
      LET_REC_ERROR_32, LET_REC_ERROR_33, LET_REC_ERROR_34, LET_REC_ERROR_35,
      LET_REC_ERROR_36, LET_REC_ERROR_37, LET_REC_ERROR_38, LET_REC_ERROR_39,
      LET_REC_ERROR_40, LET_REC_ERROR_41, LET_REC_ERROR_42, LET_REC_ERROR_43,
      LET_REC_ERROR_44, LET_REC_ERROR_45, LET_REC_ERROR_46, LET_REC_ERROR_47,
      LET_REC_ERROR_48, LET_REC_ERROR_49, LET_REC_ERROR_50, LET_REC_ERROR_51,
      LET_REC_ERROR_52, LET_REC_ERROR_53, LET_REC_ERROR_54, LET_REC_ERROR_55,
      CURRIED_LET_REC_ERROR_1, CURRIED_LET_REC_ERROR_2,
  ...
  { IDENTIFIER, APPLICATION, INFIX_OPERATION_1, INFIX_OPERATION_2,
      ...
      OPERATOR_7, OPERATOR_8, OPERATOR_9, OPERATOR_10, SIMPLE_EXPR_1,
      SIMPLE_EXPR_2, EXPR_SIMPLE_TYPE, EXPR_BOOLEAN_TYPE, EXPR_INTEGER_TYPE,
      EXPR_UNIT_TYPE, EXPR_ARROW_TYPE, EXPR_TYPE_VARIABLE, EXPR_TYPE_NAME,
      EXPR_REC_TYPE, REC_1, REC_2, LET_REC_1, LET_REC_2, CURRIED_LET_REC_1,
      CURRIED_LET_REC_2, CURRIED_LET_REC_3, CURRIED_LET_REC_4, SELF, OBJECT_1,
      OBJECT_2, OBJECT_3, OBJECT_4, DUPLICATION_1, DUPLICATION_2,
      DUPLICATION_3, SEND, ROW_1, ROW_2, ROW_3, ROW_4, ROW_5, ROW_6, ATTRIBUTE,
      METHOD_1, METHOD_2, CURRIED_METHOD_1, CURRIED_METHOD_2, CURRIED_METHOD_3,
      CURRIED_METHOD_4, EXPR_OBJECT_TYPE_1, EXPR_OBJECT_TYPE_2,
      EXPR_ROW_TYPE_1, EXPR_ROW_TYPE_2 };
  ...
  { INFIX_OPERATION_ERROR_1, INFIX_OPERATION_ERROR_2, INFIX_OPERATION_ERROR_3,
      ...
      EXPR_REC_TYPE_ERROR_2, EXPR_REC_TYPE_ERROR_3, REC_ERROR_1, REC_ERROR_2,
      REC_ERROR_3, REC_ERROR_4, REC_ERROR_5, REC_ERROR_6, REC_ERROR_7,
      REC_ERROR_8, REC_ERROR_9, REC_ERROR_10, REC_ERROR_11, REC_ERROR_12,
      REC_ERROR_13, REC_ERROR_14, REC_ERROR_15, REC_ERROR_16, REC_ERROR_17,
      REC_ERROR_18, REC_ERROR_19, REC_ERROR_20, REC_ERROR_21, REC_ERROR_22,
      ...
      LET_REC_ERROR_13, LET_REC_ERROR_14, LET_REC_ERROR_15, LET_REC_ERROR_16,
      LET_REC_ERROR_17, LET_REC_ERROR_18, LET_REC_ERROR_19, LET_REC_ERROR_20,
      LET_REC_ERROR_21, LET_REC_ERROR_22, LET_REC_ERROR_23, LET_REC_ERROR_24,
      LET_REC_ERROR_25, LET_REC_ERROR_26, LET_REC_ERROR_27, LET_REC_ERROR_28,
      LET_REC_ERROR_29, LET_REC_ERROR_30, LET_REC_ERROR_31, LET_REC_ERROR_32,
      LET_REC_ERROR_33, LET_REC_ERROR_34, LET_REC_ERROR_35, LET_REC_ERROR_36,
      LET_REC_ERROR_37, LET_REC_ERROR_38, LET_REC_ERROR_39, LET_REC_ERROR_40,
      LET_REC_ERROR_41, LET_REC_ERROR_42, LET_REC_ERROR_43, LET_REC_ERROR_44,
      LET_REC_ERROR_45, LET_REC_ERROR_46, LET_REC_ERROR_47, LET_REC_ERROR_48,
      LET_REC_ERROR_49, LET_REC_ERROR_50, LET_REC_ERROR_51, LET_REC_ERROR_52,
      LET_REC_ERROR_53, LET_REC_ERROR_54, LET_REC_ERROR_55,
      CURRIED_LET_REC_ERROR_1, CURRIED_LET_REC_ERROR_2,
      CURRIED_LET_REC_ERROR_3, CURRIED_LET_REC_ERROR_4,
      CURRIED_LET_REC_ERROR_5, CURRIED_LET_REC_ERROR_6,
      CURRIED_LET_REC_ERROR_7, CURRIED_LET_REC_ERROR_8,
      ...
      DUPLICATION_ERROR_4, DUPLICATION_ERROR_5, SEND_ERROR, ATTRIBUTE_ERROR_1,
      ATTRIBUTE_ERROR_2, ATTRIBUTE_ERROR_3, ATTRIBUTE_ERROR_4,
      ATTRIBUTE_ERROR_5, ATTRIBUTE_ERROR_6, ATTRIBUTE_ERROR_7,
      ATTRIBUTE_ERROR_8, ATTRIBUTE_ERROR_9, ATTRIBUTE_ERROR_10,
      ATTRIBUTE_ERROR_11, ATTRIBUTE_ERROR_12, ATTRIBUTE_ERROR_13,
      ATTRIBUTE_ERROR_14, METHOD_ERROR_1, METHOD_ERROR_2, METHOD_ERROR_3,
      METHOD_ERROR_4, METHOD_ERROR_5, METHOD_ERROR_6, METHOD_ERROR_7,
      METHOD_ERROR_8, METHOD_ERROR_9, METHOD_ERROR_10, METHOD_ERROR_11,
      METHOD_ERROR_12, METHOD_ERROR_13, METHOD_ERROR_14, METHOD_ERROR_15,
      METHOD_ERROR_16, METHOD_ERROR_17, METHOD_ERROR_18, METHOD_ERROR_19,
      METHOD_ERROR_20, METHOD_ERROR_21, METHOD_ERROR_22, METHOD_ERROR_23,
      METHOD_ERROR_24, METHOD_ERROR_25, METHOD_ERROR_26, METHOD_ERROR_27,
      METHOD_ERROR_28, METHOD_ERROR_29, METHOD_ERROR_30, METHOD_ERROR_31,
      METHOD_ERROR_32, METHOD_ERROR_33, METHOD_ERROR_34, METHOD_ERROR_35,
      METHOD_ERROR_36, METHOD_ERROR_37, METHOD_ERROR_38,
      CURRIED_METHOD_ERROR_1, CURRIED_METHOD_ERROR_2, CURRIED_METHOD_ERROR_3,
      CURRIED_METHOD_ERROR_4, CURRIED_METHOD_ERROR_5, CURRIED_METHOD_ERROR_6,
      CURRIED_METHOD_ERROR_7, CURRIED_METHOD_ERROR_8, CURRIED_METHOD_ERROR_9,
      CURRIED_METHOD_ERROR_10, CURRIED_METHOD_ERROR_11,
      CURRIED_METHOD_ERROR_12, CURRIED_METHOD_ERROR_13,
      CURRIED_METHOD_ERROR_14, CURRIED_METHOD_ERROR_15,
      CURRIED_METHOD_ERROR_16, CURRIED_METHOD_ERROR_17,
      CURRIED_METHOD_ERROR_18, CURRIED_METHOD_ERROR_19,
      CURRIED_METHOD_ERROR_20, CURRIED_METHOD_ERROR_21,
      CURRIED_METHOD_ERROR_22, CURRIED_METHOD_ERROR_23,
      CURRIED_METHOD_ERROR_24, CURRIED_METHOD_ERROR_25,
      CURRIED_METHOD_ERROR_26, CURRIED_METHOD_ERROR_27,
      CURRIED_METHOD_ERROR_28, CURRIED_METHOD_ERROR_29,
      CURRIED_METHOD_ERROR_30, CURRIED_METHOD_ERROR_31,
      CURRIED_METHOD_ERROR_32, CURRIED_METHOD_ERROR_33,
      CURRIED_METHOD_ERROR_34, CURRIED_METHOD_ERROR_35,
      CURRIED_METHOD_ERROR_36, CURRIED_METHOD_ERROR_37,
      CURRIED_METHOD_ERROR_38, CURRIED_METHOD_ERROR_39,
      CURRIED_METHOD_ERROR_40, CURRIED_METHOD_ERROR_41,
      EXPR_OBJECT_TYPE_ERROR_1, EXPR_OBJECT_TYPE_ERROR_2,
      EXPR_ROW_TYPE_ERROR_2, EXPR_ROW_TYPE_ERROR_3, EXPR_ROW_TYPE_ERROR_5,
  ...
  { SIMPLE_TYPE_ERROR_1, SIMPLE_TYPE_ERROR_2, ARROW_TYPE_ERROR,
      ...
      OBJECT_TYPE_ERROR_1, OBJECT_TYPE_ERROR_2, ROW_TYPE_ERROR_2,
      ROW_TYPE_ERROR_3, ROW_TYPE_ERROR_5, ROW_TYPE_ERROR_6, ROW_TYPE_ERROR_7,
      ROW_TYPE_ERROR_8, ROW_TYPE_ERROR_9, ROW_TYPE_ERROR_10, ROW_TYPE_ERROR_11,
      ROW_TYPE_ERROR_12, ROW_TYPE_ERROR_13, ROW_TYPE_ERROR_14,
      ROW_TYPE_ERROR_18, ROW_TYPE_ERROR_19 };
  ...
  { IDENTIFIER, APPLICATION, INFIX_OPERATION_1, INFIX_OPERATION_2,
      ...
      METHOD_1, METHOD_2, CURRIED_METHOD_1, CURRIED_METHOD_2, CURRIED_METHOD_3,
      CURRIED_METHOD_4, EXPR_OBJECT_TYPE_1, EXPR_OBJECT_TYPE_2,
      EXPR_ROW_TYPE_1, EXPR_ROW_TYPE_2, EXPR_ROW_TYPE_3, EXPR_ROW_TYPE_4,
      CLASS_2, CLASS_3, CLASS_4, CLASS_5, CLASS_6, INHERIT_1, INHERIT_2,
      INHERIT_3, INHERIT_4, INHERIT_5, INHERIT_6, NEW, EXPR_CLASS_TYPE_1,
      EXPR_CLASS_TYPE_2 };
  ...
  { INFIX_OPERATION_ERROR_1, INFIX_OPERATION_ERROR_2, INFIX_OPERATION_ERROR_3,
      ...
      CLASS_ERROR_24, CLASS_ERROR_25, CLASS_ERROR_26, CLASS_ERROR_26,
      CLASS_ERROR_27, CLASS_ERROR_28, CLASS_ERROR_30, CLASS_ERROR_31,
      CLASS_ERROR_32, CLASS_ERROR_33, CLASS_ERROR_34, CLASS_ERROR_35,
      CLASS_ERROR_36, CLASS_ERROR_37, CLASS_ERROR_38, CLASS_ERROR_39,
      ...
      INHERIT_ERROR_10, INHERIT_ERROR_11, INHERIT_ERROR_12, INHERIT_ERROR_13,
      INHERIT_ERROR_14, INHERIT_ERROR_15, INHERIT_ERROR_16, INHERIT_ERROR_17,
      INHERIT_ERROR_18, INHERIT_ERROR_19, INHERIT_ERROR_20, INHERIT_ERROR_21,
      INHERIT_ERROR_22, INHERIT_ERROR_23, INHERIT_ERROR_24, INHERIT_ERROR_25,
      INHERIT_ERROR_26, INHERIT_ERROR_27, INHERIT_ERROR_28, INHERIT_ERROR_29,
      INHERIT_ERROR_30, INHERIT_ERROR_31, INHERIT_ERROR_32, INHERIT_ERROR_33,
      INHERIT_ERROR_34, INHERIT_ERROR_35, INHERIT_ERROR_36, INHERIT_ERROR_37,
      INHERIT_ERROR_38, INHERIT_ERROR_39, INHERIT_ERROR_40, INHERIT_ERROR_41,
      INHERIT_ERROR_42, INHERIT_ERROR_43, INHERIT_ERROR_44, INHERIT_ERROR_45,
      INHERIT_ERROR_46, INHERIT_ERROR_47, INHERIT_ERROR_48, INHERIT_ERROR_49,
      INHERIT_ERROR_50, NEW_ERROR, EXPR_CLASS_TYPE_ERROR_1,
  ...
  { SIMPLE_TYPE_ERROR_1, SIMPLE_TYPE_ERROR_2, ARROW_TYPE_ERROR,
      ...
      ROW_TYPE_ERROR_8, ROW_TYPE_ERROR_9, ROW_TYPE_ERROR_10, ROW_TYPE_ERROR_11,
      ROW_TYPE_ERROR_12, ROW_TYPE_ERROR_13, ROW_TYPE_ERROR_14,
      ROW_TYPE_ERROR_18, ROW_TYPE_ERROR_19, ROW_TYPE_ERROR_20,
      ROW_TYPE_ERROR_21, ROW_TYPE_ERROR_22, ROW_TYPE_ERROR_23,
      ROW_TYPE_ERROR_24, ROW_TYPE_ERROR_25, ROW_TYPE_ERROR_26,
      ROW_TYPE_ERROR_27, ROW_TYPE_ERROR_28, ROW_TYPE_ERROR_29,
      ROW_TYPE_ERROR_30, ROW_TYPE_ERROR_31, ROW_TYPE_ERROR_32,
      ROW_TYPE_ERROR_33, ROW_TYPE_ERROR_34, ROW_TYPE_ERROR_35,
      ROW_TYPE_ERROR_36, ROW_TYPE_ERROR_37, ROW_TYPE_ERROR_38,
      ROW_TYPE_ERROR_39, ROW_TYPE_ERROR_40, ROW_TYPE_ERROR_41,
      ROW_TYPE_ERROR_42, ROW_TYPE_ERROR_43, ROW_TYPE_ERROR_44,
      ROW_TYPE_ERROR_45, ROW_TYPE_ERROR_46, ROW_TYPE_ERROR_47,
      ROW_TYPE_ERROR_48, CLASS_TYPE_ERROR_1, CLASS_TYPE_ERROR_2,
      CLASS_TYPE_ERROR_3, CLASS_TYPE_ERROR_4, CLASS_TYPE_ERROR_5,
      CLASS_TYPE_ERROR_6, CLASS_TYPE_ERROR_7, CLASS_TYPE_ERROR_8,
      CLASS_TYPE_ERROR_9, CLASS_TYPE_ERROR_10, CLASS_TYPE_ERROR_11,
      CLASS_TYPE_ERROR_12, CLASS_TYPE_ERROR_13, CLASS_TYPE_ERROR_14,
      CLASS_TYPE_ERROR_15, CLASS_TYPE_ERROR_16, CLASS_TYPE_ERROR_17,
      CLASS_TYPE_ERROR_18 };
  ...
  { IDENTIFIER, APPLICATION, INFIX_OPERATION_1, INFIX_OPERATION_2,
      ...
      EXPR_UNIT_TYPE, EXPR_ARROW_TYPE, EXPR_TYPE_VARIABLE, EXPR_TYPE_NAME,
      EXPR_REC_TYPE, REC_1, REC_2, LET_REC_1, LET_REC_2, CURRIED_LET_REC_1,
      CURRIED_LET_REC_2, CURRIED_LET_REC_3, CURRIED_LET_REC_4,
      INFIX_OPERATION_11, MULTI_LAMBDA_1, MULTI_LAMBDA_2, MULTI_LET_1,
      MULTI_LET_2, FST, SND, CONS, IS_EMPTY, HD, TL, OPERATOR_11, EMPTY_LIST,
      PROJECTION, TUPLE, LIST, EXPR_TUPLE_TYPE_1, EXPR_TUPLE_TYPE_2,
      EXPR_LIST_TYPE };
  ...
  { INFIX_OPERATION_ERROR_1, INFIX_OPERATION_ERROR_2, INFIX_OPERATION_ERROR_3,
      ...
      MULTI_LAMBDA_ERROR_36, MULTI_LAMBDA_ERROR_37, MULTI_LAMBDA_ERROR_38,
      MULTI_LAMBDA_ERROR_39, MULTI_LET_ERROR_1, MULTI_LET_ERROR_2,
      ...
      MULTI_LET_ERROR_12, MULTI_LET_ERROR_13, MULTI_LET_ERROR_14,
      MULTI_LET_ERROR_15, MULTI_LET_ERROR_16, MULTI_LET_ERROR_17,
      MULTI_LET_ERROR_18, MULTI_LET_ERROR_19, MULTI_LET_ERROR_20,
      MULTI_LET_ERROR_21, MULTI_LET_ERROR_22, MULTI_LET_ERROR_23,
      MULTI_LET_ERROR_24, MULTI_LET_ERROR_25, MULTI_LET_ERROR_26,
      MULTI_LET_ERROR_27, MULTI_LET_ERROR_28, MULTI_LET_ERROR_29,
      MULTI_LET_ERROR_30, MULTI_LET_ERROR_31, MULTI_LET_ERROR_32,
      MULTI_LET_ERROR_33, MULTI_LET_ERROR_34, MULTI_LET_ERROR_35,
      MULTI_LET_ERROR_36, MULTI_LET_ERROR_37, MULTI_LET_ERROR_38,
      MULTI_LET_ERROR_39, MULTI_LET_ERROR_40, MULTI_LET_ERROR_41,
      MULTI_LET_ERROR_42, MULTI_LET_ERROR_43, MULTI_LET_ERROR_44,
      MULTI_LET_ERROR_45, MULTI_LET_ERROR_46, MULTI_LET_ERROR_47,
      MULTI_LET_ERROR_48, MULTI_LET_ERROR_49, MULTI_LET_ERROR_50,
      MULTI_LET_ERROR_51, MULTI_LET_ERROR_52, MULTI_LET_ERROR_53,
      MULTI_LET_ERROR_54, MULTI_LET_ERROR_55, MULTI_LET_ERROR_56,
      MULTI_LET_ERROR_57, MULTI_LET_ERROR_58, MULTI_LET_ERROR_59,
      MULTI_LET_ERROR_60, MULTI_LET_ERROR_61, MULTI_LET_ERROR_62,
      MULTI_LET_ERROR_63, MULTI_LET_ERROR_64, MULTI_LET_ERROR_65,
      MULTI_LET_ERROR_66, MULTI_LET_ERROR_67, MULTI_LET_ERROR_68,
      MULTI_LET_ERROR_69, MULTI_LET_ERROR_70, MULTI_LET_ERROR_71,
      MULTI_LET_ERROR_72, MULTI_LET_ERROR_73, MULTI_LET_ERROR_74,
      MULTI_LET_ERROR_75, MULTI_LET_ERROR_76, MULTI_LET_ERROR_77,
      MULTI_LET_ERROR_78, TUPLE_ERROR_1, TUPLE_ERROR_2, TUPLE_ERROR_3,
      TUPLE_ERROR_4, TUPLE_ERROR_5, TUPLE_ERROR_6, TUPLE_ERROR_7, LIST_ERROR_1,
      LIST_ERROR_2, LIST_ERROR_3, LIST_ERROR_4, LIST_ERROR_5, LIST_ERROR_6,
      LIST_ERROR_7, EXPR_TUPLE_TYPE_ERROR_1, EXPR_TUPLE_TYPE_ERROR_2 };


  private static String [] L3TYPE_NORMAL = new String []
  { SIMPLE_TYPE, BOOLEAN_TYPE, INTEGER_TYPE, UNIT_TYPE, TYPE_VARIABLE,
      TYPE_NAME, REC_TYPE, ARROW_TYPE, TUPLE_TYPE_1, TUPLE_TYPE_2, LIST_TYPE };


  private static String [] L3TYPE_ERROR = new String []
  { SIMPLE_TYPE_ERROR_1, SIMPLE_TYPE_ERROR_2, ARROW_TYPE_ERROR,
      REC_TYPE_ERROR_1, REC_TYPE_ERROR_2, REC_TYPE_ERROR_3, TUPLE_TYPE_ERROR_1,
      TUPLE_TYPE_ERROR_2 };
  ...
  { IDENTIFIER, APPLICATION, INFIX_OPERATION_1, INFIX_OPERATION_2,
      ...
      MULTI_LET_2, FST, SND, CONS, IS_EMPTY, HD, TL, OPERATOR_11, EMPTY_LIST,
      PROJECTION, TUPLE, LIST, EXPR_TUPLE_TYPE_1, EXPR_TUPLE_TYPE_2,
      EXPR_LIST_TYPE, INFIX_OPERATION_12, CONDITION1, WHILE, REF, DEREF,
      OPERATOR_12, EXPR_REF_TYPE, SEQUENCE_1, SEQUENCE_2 };
  ...
  { INFIX_OPERATION_ERROR_1, INFIX_OPERATION_ERROR_2, INFIX_OPERATION_ERROR_3,
      ...
      INFIX_OPERATION_ERROR_8, INFIX_OPERATION_ERROR_9,
      INFIX_OPERATION_ERROR_10, AND_ERROR, OR_ERROR, CONDITION_ERROR_1,
      CONDITION_ERROR_2, CONDITION_ERROR_3, CONDITION_ERROR_5,
      CONDITION_ERROR_6, CONDITION_ERROR_7, CONDITION_ERROR_8,
      CONDITION_ERROR_9, CONDITION_ERROR_10, CONDITION_ERROR_11,
      CONDITION_ERROR_12, CONDITION_ERROR_13, CONDITION_ERROR_14,
      CONDITION_ERROR_15, LAMBDA_ERROR_1, LAMBDA_ERROR_2, LAMBDA_ERROR_3,
      LAMBDA_ERROR_4, LAMBDA_ERROR_5, LAMBDA_ERROR_6, LET_ERROR_1,
      LAMBDA_ERROR_7, LAMBDA_ERROR_8, LAMBDA_ERROR_9, LAMBDA_ERROR_10,
      LAMBDA_ERROR_11, LAMBDA_ERROR_12, LAMBDA_ERROR_13, LAMBDA_ERROR_14,
      LAMBDA_ERROR_15, LAMBDA_ERROR_16, LAMBDA_ERROR_17, LAMBDA_ERROR_18,
      LAMBDA_ERROR_19, LAMBDA_ERROR_20, LAMBDA_ERROR_21, LAMBDA_ERROR_22,
      LAMBDA_ERROR_23, LET_ERROR_2, LET_ERROR_3, LET_ERROR_4, LET_ERROR_5,
      LET_ERROR_6, LET_ERROR_7, LET_ERROR_8, LET_ERROR_9, LET_ERROR_10,
      LET_ERROR_11, LET_ERROR_12, LET_ERROR_13, LET_ERROR_14, LET_ERROR_15,
      LET_ERROR_16, LET_ERROR_17, LET_ERROR_18, LET_ERROR_19, LET_ERROR_20,
      LET_ERROR_21, LET_ERROR_22, LET_ERROR_23, LET_ERROR_24, LET_ERROR_25,
      LET_ERROR_26, LET_ERROR_27, LET_ERROR_28, LET_ERROR_29, LET_ERROR_30,
      LET_ERROR_31, LET_ERROR_32, LET_ERROR_33, LET_ERROR_34, LET_ERROR_35,
      LET_ERROR_36, LET_ERROR_37, LET_ERROR_38, LET_ERROR_39, LET_ERROR_40,
      LET_ERROR_41, LET_ERROR_42, LET_ERROR_43, LET_ERROR_44, LET_ERROR_45,
      LET_ERROR_46, LET_ERROR_47, LET_ERROR_48, LET_ERROR_49, LET_ERROR_50,
      LET_ERROR_51, LET_ERROR_52, CURRIED_LET_ERROR_1, CURRIED_LET_ERROR_2,
      ...
      COERCION_ERROR_2, COERCION_ERROR_3, COERCION_ERROR_4, COERCION_ERROR_5,
      COERCION_ERROR_6, COERCION_ERROR_7, COERCION_ERROR_8, COERCION_ERROR_9,
      COERCION_ERROR_10, COERCION_ERROR_11, COERCION_ERROR_12,
      COERCION_ERROR_13, COERCION_ERROR_14, COERCION_ERROR_15,
      COERCION_ERROR_16, COERCION_ERROR_17, COERCION_ERROR_18,
      COERCION_ERROR_19, SIMPLE_EXPR_ERROR_1, SIMPLE_EXPR_ERROR_2,
      SIMPLE_EXPR_ERROR_3, EXPR_SIMPLE_TYPE_ERROR_1, EXPR_SIMPLE_TYPE_ERROR_2,
      ...
      REC_ERROR_19, REC_ERROR_20, REC_ERROR_21, REC_ERROR_22, LET_REC_ERROR_1,
      ...
      LET_REC_ERROR_10, LET_REC_ERROR_11, LET_REC_ERROR_12, LET_REC_ERROR_13,
      LET_REC_ERROR_14, LET_REC_ERROR_15, LET_REC_ERROR_16, LET_REC_ERROR_17,
      LET_REC_ERROR_18, LET_REC_ERROR_19, LET_REC_ERROR_20, LET_REC_ERROR_21,
      LET_REC_ERROR_22, LET_REC_ERROR_23, LET_REC_ERROR_24, LET_REC_ERROR_25,
      LET_REC_ERROR_26, LET_REC_ERROR_27, LET_REC_ERROR_28, LET_REC_ERROR_29,
      LET_REC_ERROR_30, LET_REC_ERROR_31, LET_REC_ERROR_32, LET_REC_ERROR_33,
      LET_REC_ERROR_34, LET_REC_ERROR_35, LET_REC_ERROR_36, LET_REC_ERROR_37,
      LET_REC_ERROR_38, LET_REC_ERROR_39, LET_REC_ERROR_40, LET_REC_ERROR_41,
      LET_REC_ERROR_42, LET_REC_ERROR_43, LET_REC_ERROR_44, LET_REC_ERROR_45,
      LET_REC_ERROR_46, LET_REC_ERROR_47, LET_REC_ERROR_48, LET_REC_ERROR_49,
      LET_REC_ERROR_50, LET_REC_ERROR_51, LET_REC_ERROR_52, LET_REC_ERROR_53,
      ...
      CURRIED_LET_REC_ERROR_40, INFIX_OPERATION_ERROR_11, MULTI_LAMBDA_ERROR_1,
      MULTI_LAMBDA_ERROR_2, MULTI_LAMBDA_ERROR_3, MULTI_LAMBDA_ERROR_4,
      MULTI_LAMBDA_ERROR_5, MULTI_LAMBDA_ERROR_6, MULTI_LAMBDA_ERROR_7,
      MULTI_LAMBDA_ERROR_8, MULTI_LAMBDA_ERROR_9, MULTI_LAMBDA_ERROR_10,
      MULTI_LAMBDA_ERROR_11, MULTI_LAMBDA_ERROR_12, MULTI_LAMBDA_ERROR_13,
      MULTI_LAMBDA_ERROR_14, MULTI_LAMBDA_ERROR_15, MULTI_LAMBDA_ERROR_16,
      MULTI_LAMBDA_ERROR_17, MULTI_LAMBDA_ERROR_18, MULTI_LAMBDA_ERROR_19,
      MULTI_LAMBDA_ERROR_20, MULTI_LAMBDA_ERROR_21, MULTI_LAMBDA_ERROR_22,
      MULTI_LAMBDA_ERROR_23, MULTI_LAMBDA_ERROR_24, MULTI_LAMBDA_ERROR_25,
      MULTI_LAMBDA_ERROR_26, MULTI_LAMBDA_ERROR_27, MULTI_LAMBDA_ERROR_28,
      MULTI_LAMBDA_ERROR_29, MULTI_LAMBDA_ERROR_30, MULTI_LAMBDA_ERROR_31,
      MULTI_LAMBDA_ERROR_32, MULTI_LAMBDA_ERROR_33, MULTI_LAMBDA_ERROR_34,
      MULTI_LAMBDA_ERROR_35, MULTI_LAMBDA_ERROR_36, MULTI_LAMBDA_ERROR_37,
      MULTI_LAMBDA_ERROR_38, MULTI_LAMBDA_ERROR_39, MULTI_LET_ERROR_1,
      ...
      MULTI_LET_ERROR_74, MULTI_LET_ERROR_75, MULTI_LET_ERROR_76,
      MULTI_LET_ERROR_77, MULTI_LET_ERROR_78, TUPLE_ERROR_1, TUPLE_ERROR_2,
      TUPLE_ERROR_3, TUPLE_ERROR_4, TUPLE_ERROR_5, TUPLE_ERROR_6,
      TUPLE_ERROR_7, LIST_ERROR_1, LIST_ERROR_2, LIST_ERROR_3, LIST_ERROR_4,
      LIST_ERROR_5, LIST_ERROR_6, LIST_ERROR_7, EXPR_TUPLE_TYPE_ERROR_1,
  ...
  public static boolean parseNormalExpression ( Language pLanguage, String pText )
  {
    String text = pText;
    try
    {
  ...
  public static boolean test_L0 ()
  {
    ...
    {
      output (
          "L0 Normal:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l0ErrorOkay )
    {
    ...
    {
      output (
          "L0 Error:         " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
  ...
  public static boolean test_L1 ()
  {
    ...
    {
      output (
          "L1 Normal:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l1ErrorOkay )
    {
    ...
    {
      output (
          "L1 Error:         " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l1TypeNormalOkay )
    {
    ...
    {
      output (
          "L1Type Normal:    " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l1TypeErrorOkay )
    {
    ...
    {
      output (
          "L1Type Error:     " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
  ...
  public static boolean test_L2 ()
  {
    ...
    {
      output (
          "L2 Normal:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2ErrorOkay )
    {
    ...
    {
      output (
          "L2 Error:         " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2TypeNormalOkay )
    {
    ...
    {
      output (
          "L2Type Normal:    " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2TypeErrorOkay )
    {
    ...
    {
      output (
          "L2Type Error:     " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
  ...
  public static boolean test_L2C ()
  {
    ...
    {
      output (
          "L2C Normal:       " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2CErrorOkay )
    {
    ...
    {
      output (
          "L2C Error:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    ...
    {
      output (
          "L2CType Normal:   " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2CTypeErrorOkay )
    {
    ...
    {
      output (
          "L2CType Error:    " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
  ...
  public static boolean test_L2O ()
  {
    ...
    {
      output (
          "L2O Normal:       " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2OErrorOkay )
    {
    ...
    {
      output (
          "L2O Error:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    ...
    {
      output (
          "L2OType Normal:   " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l2OTypeErrorOkay )
    {
    ...
    {
      output (
          "L2OType Error:    " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
  ...
  public static boolean test_L3 ()
  {
    ...
    {
      output (
          "L3 Normal:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l3ErrorOkay )
    {
    ...
    {
      output (
          "L3 Error:         " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.NORMAL );
    }
    if ( l3TypeNormalOkay )
    {
    ...
    {
      output (
          "L3Type Normal:    " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l3TypeErrorOkay )
    {
    ...
    {
      output (
          "L3Type Error:     " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
  ...
  public static boolean test_L4 ()
  {
    ...
    {
      output (
          "L4 Normal:        " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l4ErrorOkay )
    {
    ...
    {
      output (
          "L4 Error:         " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l4TypeNormalOkay )
    {
    ...
    {
      output (
          "L4Type Normal:    " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
    if ( l4TypeErrorOkay )
    {
    ...
    {
      output (
          "L4Type Error:     " + fillString ( "", max ) + "NOT SUCCESSFUL",
          Output.ERROR );
    }
