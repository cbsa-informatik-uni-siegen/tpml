...
/**
 * This class represents breaks that can be inserted into the item list of a pretty string builder using
 * the {@link de.unisiegen.tpml.core.prettyprinter.PrettyStringBuilder#addBreak()} method and indicate that
...
final class BreakItem extends AbstractItem {
  ...
  void determineString(StringBuilder buffer, Map<PrettyPrintable, PrettyAnnotation> annotations, List<Integer> breakOffsets, PrettyStyle[] styles) {
    ...
    breakOffsets.add(buffer.length());
  }
