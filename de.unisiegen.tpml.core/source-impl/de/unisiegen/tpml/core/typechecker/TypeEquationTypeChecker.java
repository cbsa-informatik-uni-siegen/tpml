...
public final class TypeEquationTypeChecker {
	 ...
	 *           is <code>null</code>.
	 */
	public TypeEquationTypeChecker ( MonoType pLeft, MonoType pRight, SeenTypes < TypeEquationTypeChecker > pSeenTypes ) {
		if ( pLeft == null ) {
	...
	public TypeEquationTypeChecker substitute ( TypeSubstitution s ) {
		...
		return new TypeEquationTypeChecker ( this.left.substitute ( s ), this.right.substitute ( s ), this.seenTypes );
	}
