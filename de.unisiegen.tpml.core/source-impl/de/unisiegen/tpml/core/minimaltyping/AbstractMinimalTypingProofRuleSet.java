 ...
 */
public abstract class AbstractMinimalTypingProofRuleSet extends
    AbstractProofRuleSet
{
  ...
  /**
   * Allocates a new <code>AbstractMinimalTypingProofRuleSet</code> for the
   * specified <code>language</code>.
   * 
   * @param language the {@link Language} to which the minimal typing proof
   *          rules in this set belong.
   * @throws NullPointerException if <code>language</code> is
   *           <code>null</code>.
   */
  protected AbstractMinimalTypingProofRuleSet ( Language language )
  {
    super ( language );
  }
   ...
   * @param applyMethod the implementation of the apply method for the type
   *          checker.
   ...
   * registered proof rule will be used first when guessing.
   * 
   * @param group the group id of the type rule, see the description of the
   *          {@link AbstractProofRule#getGroup()} method for details.
      ...
      final Method updateMethod )
  {
    ...
    register ( new AbstractMinimalTypingProofRule ( group, name )
    {

      @Override
      protected void applyInternal ( MinimalTypingProofContext context,
          MinimalTypingProofNode node ) throws Exception
      {
        applyMethod.invoke ( AbstractMinimalTypingProofRuleSet.this, context,
            node );
      }


      @Override
      protected void updateInternal ( MinimalTypingProofContext context,
          MinimalTypingProofNode node ) throws Exception
      {
        if ( updateMethod != null )
        {
          updateMethod.invoke ( AbstractMinimalTypingProofRuleSet.this,
              context, node );
        }
      }
    } );
   ...
   * last registered proof rule will be used first when guessing.
   * 
   * @param group the group id of the type rule, see the description of the
   *          {@link AbstractProofRule#getGroup()} method for details.
   * @param name the name of the rule.
  ...
  private Method getMethodByName ( String methodName )
  {
    ...
    try
    {
      ...
      { MinimalTypingProofContext.class, MinimalTypingProofNode.class } );
    }
