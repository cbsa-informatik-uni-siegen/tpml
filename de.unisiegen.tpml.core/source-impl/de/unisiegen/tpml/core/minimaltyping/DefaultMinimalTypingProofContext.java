    ...
    MinimalTypingProofContext
{
   ...
   *      de.unisiegen.tpml.core.types.MonoType)
   */
  public void addProofNode ( MinimalTypingProofNode node, MonoType type,
      MonoType type2 )
  {
    this.model.contextAddProofNode ( this,
        ( AbstractMinimalTypingProofNode ) node, type, type2 );
  ...
  {
    this.model.contextSetProofNodeType ( this,
        ( AbstractMinimalTypingProofNode ) node, type );
  }
   ...
   * {@inheritDoc}
   * 
   * @see de.unisiegen.tpml.core.subtypingrec.RecSubTypingProofContext#addSeenType(de.unisiegen.tpml.core.types.MonoType,
   *      de.unisiegen.tpml.core.types.MonoType) public void addSeenType (
   *      MonoType type, MonoType type2 ) { DefaultSubType subtype = new
   *      DefaultSubType ( type, type2 ); this.seenTypes.add ( subtype ); }
   */
}
