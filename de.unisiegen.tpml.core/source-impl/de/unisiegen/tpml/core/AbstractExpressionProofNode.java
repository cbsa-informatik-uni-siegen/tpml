...
/**
 * Abstract base class for proof nodes that present the fundamental parts
 * of the {@link de.unisiegen.tpml.core.AbstractExpressionProofModel}s. The
 * user interface and other modules should never access methods of this class
 ...
 * @version $Rev$
 */
public abstract class AbstractExpressionProofNode extends AbstractProofNode implements ExpressionProofNode {
  //
  // Constants
  //
   ...
   */
  protected AbstractExpressionProofNode(Expression expression) {
    if (expression == null) {
   ...
   * {@link ExpressionProofModel#translateToCoreSyntax(ExpressionProofNode)} method.
   * 
   ...
   * @see #getSteps()
   * 
   * @throws NullPointerException if any of the items in the
   *                              <code>steps</code> array is
   *                              <code>null</code>.
   */
