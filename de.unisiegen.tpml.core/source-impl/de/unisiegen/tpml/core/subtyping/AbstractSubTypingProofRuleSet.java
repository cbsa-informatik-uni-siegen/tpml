    ...
    AbstractProofRuleSet
{
  ...
  /**
   * Allocates a new <code>AbstractSubTypingProofRuleSet</code> for the
   * specified <code>language</code>.
   * 
   * @param language the {@link Language} to which the subtyping proof rules in
   *          this set belong.
   * @param mode the mode chosen by the user
   * @throws NullPointerException if <code>language</code> is
   *           <code>null</code>.
   */
  public AbstractSubTypingProofRuleSet ( Language language,
      ...
      final Method updateMethod )
  {
    ...
    register ( new AbstractSubTypingProofRule ( group, name )
    {
  ...
  private Method getMethodByName ( String methodName )
  {
    ...
    try
    {
      ...
      { SubTypingProofContext.class, SubTypingProofNode.class } );
    }
