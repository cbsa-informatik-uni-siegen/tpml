 ...
 */
public abstract class AbstractSubTypingProofRuleSet extends AbstractProofRuleSet {
	 ...
	 */
	public AbstractSubTypingProofRuleSet ( Language language, @SuppressWarnings ( "unused" )
	boolean mode ) {
		super ( language );
	}
	...
	private Method getMethodByName ( String methodName ) {
		...
		try {
			...
			return getClass ( ).getMethod ( methodName,
					new Class[] { SubTypingProofContext.class, SubTypingProofNode.class } );
