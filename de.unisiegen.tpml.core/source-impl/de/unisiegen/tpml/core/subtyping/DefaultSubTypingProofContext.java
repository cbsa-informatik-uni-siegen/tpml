...
public class DefaultSubTypingProofContext implements SubTypingProofContext
{
   ...
   * 
   * @param pModel the rec subtyping proof model with which the context is
   *          associated.
   */
   ...
   * @param pNode the proof node to which to apply the <code>rule</code>. if
   *          the user didn't enter a type.
   ...
   * {@inheritDoc}
   * 
   * @see de.unisiegen.tpml.core.subtyping.SubTypingProofContext#addProofNode(de.unisiegen.tpml.core.subtyping.SubTypingProofNode,
   *      MonoType, MonoType)
   */
