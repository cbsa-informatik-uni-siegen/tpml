 ...
 */
public class OldDefaultTypeInferenceProofContext implements
    TypeInferenceProofContext
{
   ...
   */
  public OldDefaultTypeInferenceProofContext (
      ...
      throws ProofRuleException, UnifyException
  {
    ...
    for ( int i = 0 ; i < typeNode.getChildCount () ; i++ )
    {
      ...
      if ( childNode instanceof DefaultTypeCheckerExpressionProofNode )
      {
        ...
        insert = new TypeJudgement ( child.getEnvironment (), child
