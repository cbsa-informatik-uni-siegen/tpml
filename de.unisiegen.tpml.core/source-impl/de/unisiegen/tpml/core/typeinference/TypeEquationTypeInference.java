 ...
 */
public final class TypeEquationTypeInference implements ShowBondsInput, TypeFormula, PrettyPrintable,
	 ...
	 *           is <code>null</code>.
	 */
	public TypeEquationTypeInference ( final MonoType pLeft, final MonoType pRight,
	...
	public TypeEquationTypeInference clone ( ) {
		return new TypeEquationTypeInference ( this.left, this.right, this.seenTypes );
	}
	 ...
	 */
	public TypeEquationTypeInference substitute ( ArrayList < TypeSubstitution > substitutions ) {
