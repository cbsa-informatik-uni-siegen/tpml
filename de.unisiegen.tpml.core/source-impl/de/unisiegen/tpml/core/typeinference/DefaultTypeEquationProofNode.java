...
implements TypeEquationProofNode {
	 ...
	 */
	public DefaultTypeEquationProofNode ( final TypeEnvironment pEnvironment1, final Expression pExpression1,
			final MonoType pType1, final TypeEquationTypeInference eqns, boolean pMode ) {
