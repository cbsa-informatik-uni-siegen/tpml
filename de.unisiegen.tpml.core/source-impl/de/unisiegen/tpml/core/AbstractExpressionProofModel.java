...
/**
 * Abstract base class for all classes implementing the {@link de.unisiegen.tpml.core.ExpressionProofModel}
 * interface.
 *
 ...
 */
public abstract class AbstractExpressionProofModel extends AbstractProofModel implements ExpressionProofModel {
  //
  // Constructor (protected)
  //
  
  /**
   * Allocates a new <code>AbstractExpressionProofModel</code> using the given <code>root</code> item.
   * 
   ...
   */
  protected AbstractExpressionProofModel(AbstractExpressionProofNode root, AbstractProofRuleSet ruleSet) {
    super(root, ruleSet);
  }
   ...
   * {@inheritDoc}
   *
   * @see de.unisiegen.tpml.core.ExpressionProofModel#containsSyntacticSugar(de.unisiegen.tpml.core.ExpressionProofNode, boolean)
   */
  public boolean containsSyntacticSugar(ExpressionProofNode node, boolean recursive) {
    if (node == null) {
   ...
   * {@inheritDoc}
   *
   * @see de.unisiegen.tpml.core.ExpressionProofModel#translateToCoreSyntax(de.unisiegen.tpml.core.ExpressionProofNode, boolean)
   */
  public void translateToCoreSyntax(ExpressionProofNode node, boolean recursive) {
   ...
   * {@inheritDoc}
   *
   * @see de.unisiegen.tpml.core.AbstractProofModel#getChild(java.lang.Object, int)
   */
  @Override
