 ...
 * @version $Id: L4OSmallStepProofRuleSet.java 2860 2008-05-23 13:03:00Z fehler
 *          $
...
public class L4OSmallStepProofRuleSet extends L4SmallStepProofRuleSet
{
  ...
  public L4OSmallStepProofRuleSet ( L4OLanguage language )
  {
    super ( language );
    // Attr
    register ( L4OLanguage.L4O, ATTR_EVAL, false );
    register ( L4OLanguage.L4O, ATTR_RIGHT, false );
    // Method
    register ( L4OLanguage.L4O, METHOD_RIGHT, false );
    // Object
    register ( L4OLanguage.L4O, OBJECT_EVAL, false );
    // Send
    register ( L4OLanguage.L4O, SEND_UNFOLD, true );
    register ( L4OLanguage.L4O, SEND_ATTR, true );
    register ( L4OLanguage.L4O, SEND_SKIP, true );
    register ( L4OLanguage.L4O, SEND_EXEC, true );
    register ( L4OLanguage.L4O, SEND_EVAL, false );
  }
      ...
      ObjectExpr pObjectExpr )
  {
    ...
    return new ObjectExpr ( pObjectExpr.getId (), pObjectExpr.getTau (), row );
  }
  ...
  public Expression evaluateRow ( SmallStepProofContext pContext, Row pRow )
  {
    ...
    for ( int i = 0 ; i < rowExpressions.length ; i++ )
    {
      ...
      else
      {
         ...
         */
        pContext
            .addProofStep ( getRuleByName ( METHOD_RIGHT ), currentRowChild );
      }
    }
    return pRow;
  }
