...
/**
 * The parser class for the <code>L4O</code> language.
 * 
 * @author Benedikt Meurer
 * @version $Id$
 * @see de.unisiegen.tpml.core.languages.l4.L4AbstractParser
 */
final class L4OParser extends L4OAbstractParser
{

  /**
   * Allocates a new <code>L4OParser</code> that operates on tokens from the
   ...
   */
  L4OParser ( LanguageScanner scanner )
  {
    super ( scanner );
  }
