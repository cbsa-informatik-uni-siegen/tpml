...
/**
 * This class represents the language L2OSubtype, which serves as a factory
 * class for L2O subtype related functionality, which extends the L2SubType
 * 
...
public class L2OSUBLanguage extends L2OLanguage
{
  ...
  public SubTypingProofModel newSubTypingProofModel ( MonoType type,
      MonoType type2, boolean mode )
  {
    return new SubTypingProofModel ( type, type2, new L2OSubTypingProofRuleSet (
        this, mode ), mode );
  }
