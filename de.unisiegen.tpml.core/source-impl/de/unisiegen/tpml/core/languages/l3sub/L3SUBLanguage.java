...
/**
 * This class represents the language L3Subtype, which serves as a factory class
 * for L3 subtype related functionality, which extends the L2SubType.
 * 
...
public class L3SUBLanguage extends L3Language
{
  ...
  public SubTypingProofModel newSubTypingProofModel (
      ...
      boolean mode )
  {
    return new SubTypingProofModel ( type, type2, new L3SubTypingProofRuleSet (
        this, mode ), mode );
  }
