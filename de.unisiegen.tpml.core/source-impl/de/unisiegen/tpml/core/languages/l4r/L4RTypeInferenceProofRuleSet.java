 ...
 */
public class L4RTypeInferenceProofRuleSet extends L4RTypeCheckerProofRuleSet
{

  /**
   * Allocates a new <code>L4RTypeInferenceProofRuleSet</code> for the
   ...
   *           <code>null</code>.
   */
  public L4RTypeInferenceProofRuleSet ( L4RLanguage language )
  {
    super ( language );
