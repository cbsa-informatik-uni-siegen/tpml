...
/**
 * The type parser class for the <code>L1</code> language.
 *
 ...
 */
final class L1TypeParser extends L1AbstractTypeParser {
  //
  // Constructor (package)
  //
  
  /**
   * Allocates a new <code>L1TypeParser</code> that operates on tokens from the specified <code>scanner</code>.
   * 
   ...
   */
  L1TypeParser(LanguageTypeScanner scanner) {
    super(scanner);
  }
