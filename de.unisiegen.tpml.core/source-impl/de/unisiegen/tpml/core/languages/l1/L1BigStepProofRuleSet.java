...
public class L1BigStepProofRuleSet extends L0BigStepProofRuleSet {
  ...
  public L1BigStepProofRuleSet(L1Language language) {
    ...
    registerByMethodName(L2Language.L2, "AND-FALSE", "applyAnd", "updateAndFalse"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    registerByMethodName(L2Language.L2, "AND-TRUE", "applyAnd", "updateAndTrue"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
