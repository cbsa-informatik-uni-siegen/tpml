...
public class L2CBNBigStepProofRuleSet extends L2BigStepProofRuleSet
{
  ...
  public L2CBNBigStepProofRuleSet ( L2Language language )
  {
    ...
    registerByMethodName ( L2CBNLanguage.L2CBN,
        "APP-LEFT", "applyApplicationLeft", //$NON-NLS-1$ //$NON-NLS-2$
        "updateApplicationLeft" ); //$NON-NLS-1$
    registerByMethodName ( L2CBNLanguage.L2CBN, "APP-RIGHT", //$NON-NLS-1$
        "applyApplicationRight", "updateApplicationRight" ); //$NON-NLS-1$ //$NON-NLS-2$
    unregister ( "BETA-V" ); //$NON-NLS-1$
    registerByMethodName ( L2CBNLanguage.L2CBN, "BETA", "applyBeta", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    registerByMethodName ( L2CBNLanguage.L2CBN, "LET", "applyLet", "updateLet" ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    registerByMethodName ( L1Language.L1, "OR-TRUE", "applyOr", "updateOrTrue" ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
      ...
      BigStepProofNode node )
  {
    ...
    if ( node.getChildCount () == 1 && node.getChildAt ( 0 ).isProven () )
    {
      ...
      if ( e instanceof Application )
      {
        ...
        Application application = ( Application ) e;
        Application newNode = new Application ( node0.getResult ().getValue (),
            application.getE2 () );
  ...
  public void applyLet ( BigStepProofContext context, BigStepProofNode node )
  {
    ...
    else
    {
      ...
      // add the proof node
      context
          .addProofNode ( node, let.getE2 ().substitute ( let.getId (), e1 ) );
    }
  }
