...
/**
 * The parser class for the <code>Lt1</code> language.
 *
 * @author Benedikt Meurer
 * @version $Id$
 *
 * @see de.unisiegen.tpml.core.languages.lt1.Lt1AbstractParser
 */
final class Lt1Parser extends Lt1AbstractParser {
  //
  // Constructor (package)
  //
  
  /**
   * Allocates a new <code>Lt1Parser</code> that operates on tokens from the specified <code>scanner</code>.
   * 
   ...
   */
  Lt1Parser(LanguageScanner scanner) {
    super(scanner);
  }
