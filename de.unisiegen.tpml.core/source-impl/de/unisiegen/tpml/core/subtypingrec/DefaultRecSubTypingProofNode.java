...
public class DefaultRecSubTypingProofNode extends AbstractProofNode implements RecSubTypingProofNode,
	 ...
	 */
	public PrettyStringBuilder toPrettyStringBuilder ( PrettyStringBuilderFactory pPrettyStringBuilderFactory ) {
		...
		commands
				.add ( new DefaultLatexCommand (
						...
						"\\ifarrows" + LATEX_LINE_BREAK_NEW_COMMAND //$NON-NLS-1$
								...
								+ "{#3 #4\\ <:\\ #5} $\\\\$" + LATEX_LINE_BREAK_NEW_COMMAND //$NON-NLS-1$
								+ "\\byrule{#6} " //$NON-NLS-1$
						...
						, "depth", "id", "seenTypes", "type", "type2", "rule", "space" ) ); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
	...
	public final LatexStringBuilder toLatexStringBuilder ( LatexStringBuilderFactory pLatexStringBuilderFactory,
		...
		LatexStringBuilder builder = pLatexStringBuilderFactory.newBuilder ( 0, LATEX_TYPE_CHECKER_TYPE_PROOF_NODE,
				pIndent /*, this
		 .toPrettyString ( ).toString ( ) , this.seenTypes
		...
		builder.addBuilder ( this.seenTypes
				.toLatexStringBuilder ( pLatexStringBuilderFactory, pIndent + LATEX_INDENT * 2 ), 0 );
		builder.addText ( LATEX_LINE_BREAK_SOURCE_CODE );
		builder.addText ( DefaultLatexStringBuilder.getIndent ( pIndent + LATEX_INDENT ) );
		...
		builder.addBuilder (
				this.getRight ( ).toLatexStringBuilder ( pLatexStringBuilderFactory, pIndent + LATEX_INDENT ), 0 );
		if ( this.getRule ( ) != null )
			builder.addBuilder ( this.getRule ( ).toLatexStringBuilder ( pLatexStringBuilderFactory,
