...
public class CurriedLet extends Expression
{
   ...
   *           <code>null</code>.
   */
  public CurriedLet ( String [ ] identifiers , MonoType [ ] types ,
      Expression e1 , Expression e2 )
  {
    ...
    {
      throw new IllegalArgumentException (
          "the arity of identifiers and types must match" ) ;
    }
  ...
  public CurriedLet substitute ( TypeSubstitution substitution )
  {
    ...
    return new CurriedLet ( this.identifiers , types , this.e1
  ...
  public CurriedLet substitute ( String id , Expression e )
  {
    ...
    if ( ! Arrays.asList ( identifiers ).subList ( 1 , identifiers.length )
        .contains ( id ) )
    {
