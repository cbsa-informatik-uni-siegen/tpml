...
public final class MultiLet extends Expression
{
   ...
   * @param tau the type of the <code>identifiers</code> tuple (that is the
   ...
   */
  public MultiLet ( String [ ] identifiers , MonoType tau , Expression e1 ,
      Expression e2 )
  {
    if ( identifiers == null )
    {
  ...
  public Expression substitute ( TypeSubstitution substitution )
  {
    MonoType tau = ( this.tau != null ) ? this.tau.substitute ( substitution )
        : null ;
    return new MultiLet ( this.identifiers , tau , this.e1
  ...
  public Expression substitute ( String id , Expression e )
  {
    ...
    if ( ! Arrays.asList ( identifiers ).contains ( id ) )
    {
      ...
      for ( int n = 0 ; n < identifiers.length ; ++ n )
      {
        ...
        e2 = e2.substitute ( this.identifiers [ n ] , new Identifier (
            identifiers [ n ] ) ) ;
      }
      // substitute in e2
