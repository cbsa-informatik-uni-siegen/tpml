...
public class Projection extends UnaryOperator {
  ...
  /**
   * Allocates a new {@link Projection} with the given <code>arity</code> and the <code>index</code> of 
   * the item that should be selected.
   * 
   * @param arity the arity of the tuple to which this projection can be applied.
   * @param index the index of the item to select from the tuple, starting with <code>1</code>.
   *              
   * @throws IllegalArgumentException if the <code>arity</code> or the <code>index</code> is invalid.
   */
  ...
  /**
   * Allocates a new {@link Projection} with the given <code>arity</code> and the <code>index</code> of 
   * the item that should be selected, and the string representation <code>op</code>.
   * 
   * @param arity the arity of the tuple to which this projection can be applied.
   * @param index the index of the item to select from the tuple, starting with <code>1</code>.
   ...
   */
  @Override
  public de.unisiegen.tpml.core.expressions.Expression applyTo(Expression e) throws UnaryOperatorException {
    try {
