...
public final class InfixOperation extends Expression
{
  ...
  public InfixOperation substitute ( TypeSubstitution substitution )
  {
    ...
    return ( this.e1 == e1 && this.e2 == e2 ) ? this : new InfixOperation (
        this.op , e1 , e2 ) ;
  }
  ...
  {
    PrettyStringBuilder builder = factory.newBuilder ( this , this.op
        .getPrettyPriority ( ) ) ;
    builder.addBuilder ( this.e1.toPrettyStringBuilder ( factory ) , this.op
        .getPrettyPriority ( ) ) ;
    builder.addText ( " " ) ;
    builder.addConstant ( this.op.toString ( ) ) ;
    builder.addText ( " " ) ;
    builder.addBuilder ( this.e2.toPrettyStringBuilder ( factory ) , this.op
        .getPrettyPriority ( ) + 1 ) ;
    return builder ;
  }
