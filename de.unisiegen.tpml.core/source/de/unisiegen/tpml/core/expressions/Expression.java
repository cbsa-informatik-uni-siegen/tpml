    ...
    PrettyPrintPriorities
{
   ...
   * operations, that is either {@link Assign#ASSIGN}, {@link Deref#DEREF} or
   * {@link Ref#REF}. Otherwise <code>false</code> will be returned. This
   * method is used for the
   * {@link de.unisiegen.tpml.core.interpreters.InterpreterProofModel}s to
   * enable the
