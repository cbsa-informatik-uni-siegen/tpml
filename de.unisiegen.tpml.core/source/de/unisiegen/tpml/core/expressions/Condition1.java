...
/**
 * Instances of this class represent conditions without an else block in the expression hierarchy.
 *
...
public final class Condition1 extends Expression {
  ...
  /**
   * Allocates a new <code>Condition1</code> with the specified <code>e0</code> and <code>e1</code>.
   * 
   * @param e0 the conditional block.
   * @param e1 the <code>true</code> case.
   * 
   * @throws NullPointerException if <code>e0</code> or <code>e1</code> is <code>null</code>.
   */
