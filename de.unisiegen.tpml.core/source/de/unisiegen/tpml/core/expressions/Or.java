...
public final class Or extends Expression
{
  ...
  public Expression substitute ( TypeSubstitution substitution )
  {
    ...
    return ( this.e1 == e1 && this.e2 == e2 ) ? this : new Or ( e1 , e2 ) ;
  }
      ...
      PrettyStringBuilderFactory factory )
  {
    ...
    builder
        .addBuilder ( this.e1.toPrettyStringBuilder ( factory ) , PRIO_OR_E1 ) ;
    builder.addText ( " " ) ;
    builder.addKeyword ( "||" ) ;
    builder.addText ( " " ) ;
    builder
        .addBuilder ( this.e2.toPrettyStringBuilder ( factory ) , PRIO_OR_E2 ) ;
    return builder ;
  }
