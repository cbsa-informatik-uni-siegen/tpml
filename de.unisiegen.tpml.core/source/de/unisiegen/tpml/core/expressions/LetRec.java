...
public final class LetRec extends Let
{
  ...
  public LetRec substitute ( TypeSubstitution substitution )
  {
    MonoType tau = ( this.tau != null ) ? this.tau.substitute ( substitution )
        : null ;
    return new LetRec ( this.id , tau , this.e1.substitute ( substitution ) ,
   ...
   * {@inheritDoc}
   * 
   * @see de.unisiegen.tpml.core.expressions.Let#substitute(java.lang.String,
  ...
  public Expression substitute ( String id , Expression e )
  {
    ...
    else
    {
      ...
      Expression newE1 = this.e1
          .substitute ( this.id , new Identifier ( newId ) ) ;
      // perform the substitution
      return new LetRec ( newId , this.tau , newE1.substitute ( id , e ) ,
          this.e2.substitute ( id , e ) ) ;
    }
  }
