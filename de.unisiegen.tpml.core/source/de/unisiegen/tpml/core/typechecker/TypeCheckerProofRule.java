...
/**
 * Base interface for the proof rules used within the type checker. This interface is very similar to
...
public interface TypeCheckerProofRule extends ProofRule {
   ...
   *                {@link #apply(TypeCheckerProofContext, TypeCheckerProofNode)} invokation on another
