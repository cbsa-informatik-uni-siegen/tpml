...
/**
 * Provides the functionality to pretty-print a
 * {@link de.unisiegen.tpml.core.prettyprinter.PrettyPrintable} as string while
 * extracting several informations about the printables contained within the
 * pretty string.
 * 
...
public interface PrettyString
{
  ...
  //
  /**
   * Returns the list of annotations contained within the pretty string.
   * 
   ...
   * <code>printable</code> in this pretty string. If no annotation is
   * associated with <code>printable</code> (that is, <code>printable</code>
   * is not present in the pretty string), an
   * <code>IllegalArgumentException</code> is thrown.
   * 
   * @param printable a <code>PrettyPrintable</code> instance, which is valid
   *          for the pretty string.
   * @return the annotation for <code>printable</code>.
   * @throws IllegalArgumentException if the <code>printable</code> is invalid
   *           for the pretty string.
   * @see PrettyAnnotation
   */
  ...
  /**
   * Returns an {@link PrettyCharIterator} which can be used to iterate over the
   * characters contained within the pretty string and extract certain
   * informations (like style) about the characters.
   * 
