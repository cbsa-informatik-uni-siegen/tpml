...
/**
 * An annotation for the pretty printer. Annotations are used to mark regions within the text that
 * are associated with a specific {@link de.unisiegen.tpml.core.prettyprinter.PrettyPrintable}.
 *
