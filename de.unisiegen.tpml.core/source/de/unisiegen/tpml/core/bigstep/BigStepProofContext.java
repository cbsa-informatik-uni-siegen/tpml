...
/**
 * Base interface for {@link de.unisiegen.tpml.core.bigstep.BigStepProofRule}s to interact with the
 * {@link de.unisiegen.tpml.core.bigstep.BigStepProofModel}s when applying a rule to a specified node
...
public interface BigStepProofContext {
  ...
  /**
   * Adds a new {@link BigStepProofNode} for the specified <code>expression</code> and
   * <code>store</code> as child node for the given <code>node</code>.
   * 
   * The method takes care of registering the required redo and undo actions for
   * the {@link BigStepProofModel} associated with this proof context.
   * 
   ...
   * 
   * The method takes care of registering the required redo and undo actions for the
   * {@link BigStepProofModel} associated with this proof context.
   * 
   * @param node the node, whose result to change to <code>value</code> and <code>store</code>.
   * @param value the new value for the specified <code>node</code>.
