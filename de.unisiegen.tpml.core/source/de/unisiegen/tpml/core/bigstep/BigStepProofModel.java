...
public final class BigStepProofModel extends AbstractInterpreterProofModel {
	 ...
	 *         {@link ProofNode}.
	 */
	private TreeSet < LatexCommand > getLatexCommandsInternal ( BigStepProofNode pNode ) {
		TreeSet < LatexCommand > commands = new TreeSet < LatexCommand > ( );
	...
	public LatexInstructionList getLatexInstructions ( ) {
		...
		instructions.add ( getLatexInstructionsInternal ( ( BigStepProofNode ) this.root ) );
		return instructions;
	}
	 ...
	 *         {@link ProofNode}.
	 */
	private LatexInstructionList getLatexInstructionsInternal ( BigStepProofNode pNode ) {
		LatexInstructionList instructions = new LatexInstructionList ( );
	 ...
	 *         {@link ProofNode}.
	 */
	private TreeSet < LatexPackage > getLatexPackagesInternal ( BigStepProofNode pNode ) {
		TreeSet < LatexPackage > packages = new TreeSet < LatexPackage > ( );
	...
	public final LatexStringBuilder toLatexStringBuilder ( LatexStringBuilderFactory pLatexStringBuilderFactory,
		...
		LatexStringBuilder builder = pLatexStringBuilderFactory.newBuilder ( 0, pIndent );
		{
			...
			toLatexStringBuilderInternal ( pLatexStringBuilderFactory, builder, this.root, pIndent, -1 );
		}
