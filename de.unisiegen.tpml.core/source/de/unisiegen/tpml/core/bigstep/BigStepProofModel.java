    ...
    implements LatexPrintable , LatexCommandNames
{
      ...
      ProofNode pNode )
  {
    ...
    commands.add ( new DefaultLatexCommand ( LATEX_BIG_STEP_PROOF_MODEL , 1 ,
        "\\mktree#1\\ " , "proofmodel" ) ) ; //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$ //$NON-NLS-4$
      ...
      LatexStringBuilderFactory pLatexStringBuilderFactory , int pIndent )
  {
    LatexStringBuilder builder = pLatexStringBuilderFactory.newBuilder ( 0 ,
        LATEX_BIG_STEP_PROOF_MODEL , pIndent ) ;
    return builder ;
  }
}
