 ...
 * Algorithm. The node contains to {@link MonoType}s, the first of these is
 * the subtype, and the second the overtype.
 *
...
public interface MinimalTypingTypesProofNode extends MinimalTypingProofNode {
	...
	/**
	 * Returns the second type for this type node, which is either a type variable or a concrete type.
	 * 
