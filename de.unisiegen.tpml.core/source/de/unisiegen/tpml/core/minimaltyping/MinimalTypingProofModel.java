...
public class MinimalTypingProofModel extends AbstractExpressionProofModel implements LatexPrintable, LatexCommandNames {
	...
	public ArrayList < LatexInstruction > getLatexInstructions ( ) {
		...
		for ( LatexInstruction instruction : getLatexInstructionsInternal ( ( MinimalTypingProofNode ) this.root ) ) {
	 ...
	 *         {@link ProofNode}.
	 */
	private ArrayList < LatexInstruction > getLatexInstructionsInternal ( MinimalTypingProofNode pNode ) {
		ArrayList < LatexInstruction > instructions = new ArrayList < LatexInstruction > ( );
