...
/**
 * Thrown if the {@link de.unisiegen.tpml.core.languages.LanguageFactory} cannot
 * find the {@link de.unisiegen.tpml.core.languages.Language} implementation for
 * a given language id.
 * 
...
public final class NoSuchLanguageException extends Exception
{
  ...
  //
  /**
   * Allocates a new <code>NoSuchLanguageException</code>, which indicates
   * that a lookup on a language with the specified <code>id</code> (using the
   * {@link LanguageFactory}) failed.
   * 
