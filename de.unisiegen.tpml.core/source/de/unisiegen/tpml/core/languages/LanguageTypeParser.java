...
/**
 * Interface to type parser for a given language, that are used in conjunction
 * with the language scanners to parse types from their string representations
 * to a {@link de.unisiegen.tpml.core.types.Type} hierarchy, which is used in
...
public interface LanguageTypeParser
{
   ...
   * parsed {@link MonoType} if successfull. Otherwise an exception is thrown
