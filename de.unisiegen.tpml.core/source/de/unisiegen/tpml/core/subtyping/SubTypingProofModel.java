...
public class SubTypingProofModel extends AbstractProofModel implements SubTypingModel {
	 ...
	 *         {@link ProofNode}.
	 */
	private TreeSet < LatexCommand > getLatexCommandsInternal ( SubTypingProofNode pNode ) {
		TreeSet < LatexCommand > commands = new TreeSet < LatexCommand > ( );
	...
	public LatexInstructionList getLatexInstructions ( ) {
		...
		instructions.add ( getLatexInstructionsInternal ( ( SubTypingProofNode ) this.root ) );
		return instructions;
	}
	 ...
	 *         {@link ProofNode}.
	 */
	private LatexInstructionList getLatexInstructionsInternal ( SubTypingProofNode pNode ) {
		LatexInstructionList instructions = new LatexInstructionList ( );
	 ...
	 *         {@link ProofNode}.
	 */
	private TreeSet < LatexPackage > getLatexPackagesInternal ( SubTypingProofNode pNode ) {
		TreeSet < LatexPackage > packages = new TreeSet < LatexPackage > ( );
