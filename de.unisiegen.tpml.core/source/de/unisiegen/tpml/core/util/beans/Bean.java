...
/**
 * Common interface for beans with simple property change listener support.
 * While not mandatory this interface should be implemented by all classes whose
 * instances act as Java Beans, either by implementing this interface directly,
