 ...
 * 
 * Using this class one can easily iterate over the list of child nodes
 * below a given document node. For example the following code fragment
 * 
 * <pre>
...
public final class IterableNodeList implements Iterable<Node>, NodeList {
   ...
   * specified <code>NodeList</code> and provides an implementation of
   * the <code>Iterable</code>, so developers no longer need to write
   * ugly code to iterate over node lists, but can use the Java5
   * <code>foreach</code> construct.
   * 
   * @param decorated the <code>NodeList</code> to be decorated by this
   *                  <code>IterableNodeList</code> instance.
   */
  public IterableNodeList(NodeList decorated) {
    this.decorated = decorated;
  }
  
  /**
   * Convenience wrapper for the default constructor {@link #IterableNodeList(NodeList)},
   * which determines the child nodes for <code>parent</code> and decorates the child
   * nodes list.
   * 
   * @param parent the parent <code>Node</code>, whose child nodes should be decorated
   *               by this <code>IterableNodeList</code> instance.
   *               
   ...
   * <code>Node</code>s within the decorated <code>NodeList</code>.
   *
   ...
   * 
   * @return the <code>Node</code> at <code>index</code> in the list,
   *         or <code>null</code> if the <code>index</code> points
   *         outside the list.
   * 
