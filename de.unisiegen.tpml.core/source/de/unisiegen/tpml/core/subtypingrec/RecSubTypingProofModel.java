...
public class RecSubTypingProofModel extends AbstractProofModel implements SubTypingModel {
	...
	public LatexInstructionList getLatexInstructions ( ) {
		...
		instructions.add ( getLatexInstructionsInternal ( ( RecSubTypingProofNode ) this.root ) );
		return instructions;
	}
	 ...
	 *         {@link ProofNode}.
	 */
	private LatexInstructionList getLatexInstructionsInternal ( RecSubTypingProofNode pNode ) {
		LatexInstructionList instructions = new LatexInstructionList ( );
