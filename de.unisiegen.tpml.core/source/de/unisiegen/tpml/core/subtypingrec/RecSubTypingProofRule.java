...
/**
 * Base interface for the proof rules used within the subtyping algorithm. This
...
public interface RecSubTypingProofRule extends ProofRule {
	/**
	 * Applies this subtyping proof rule to the specified <code>node</code> via
	 * the given <code>context</code>.
	 * 
	 * @param context the subtyping proof context via which the application of
	 ...
	 *           <code>node</code>.
	 */
	public void apply ( RecSubTypingProofContext context, RecSubTypingProofNode node ) throws ProofRuleException;
}
