 ...
 * as v<major>.<minor>.<update> (e.g. v0.10a). Major numbers will change at
 * the time of major reworking of some part of the system. Minor numbers for
 * each public release or change big enough to cause incompatibilities. Finally
