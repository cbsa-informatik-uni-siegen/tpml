...
public final class TypeInferenceProofModel extends AbstractProofModel {
   ...
   */
	void contextAddProofNode(final DefaultTypeInferenceProofContext context,
			...
			final TypeEquationList equations, final TypeSubstitutionList subs, final TypeCheckerProofRule rule, final TypeFormula formula) {
	/**	context.addRedoAction(new Runnable() {
		...
		final DefaultTypeInferenceProofNode child = new DefaultTypeInferenceProofNode(formulas,
				equations, subs);
