...
/**
 * The proof context for the subtyping. The proof context acts as an interface to the proof model
 * for the type rules.
 *
...
public interface SubTypingProofContext {
	...
	/**
	 * Adds a new child node below the <code>node</code>, to prove if the
	 * first <code>type</code> is a subtype of the second <code>type</code>
	 * 
