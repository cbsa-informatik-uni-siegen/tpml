...
/**
 * Instances of this class are used to represents substitutions on types.
 * 
 * In the future, this could be turned in a generalized substitution concept, and could be
...
public interface TypeSubstitution {
  ...
  /**
   * Returns the composition of this {@link TypeSubstitution} and <code>s</code>. The composition will
   * apply pairs from this substitution first and afterwards the ones from <code>s</code>.
   * 
  ...
  /**
   * Returns the set of free type variables in this {@link TypeSubstitution}, that is the free identifiers
   * in all types present in this substitution.
   * 
