...
public final class MinimalTypingProofModelTest extends JFrame {
   ...
   */
  private static final String SIMPLE = "if true then 1 else 2";
    ...
    guessButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent event) {
        try {
          ...
          JOptionPane.showMessageDialog(MinimalTypingProofModelTest.this, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
      }
    });
  ...
  public static void main(String[] args) {
    try {
      ...
      MinimalTypingProofModel model = language.newMinimalTypingProofModel(expression);
      
      // evaluate the resulting small step expression
      MinimalTypingProofModelTest window = new MinimalTypingProofModelTest(model);
