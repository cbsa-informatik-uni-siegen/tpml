...
public class TypeInferenceView extends AbstractProofView
{
	...
	public TypeInferenceView (TypeInferenceProofModel pTypeInferenceProofModel)
	{
		...
		this.component = new TypeInferenceComponent(this.typeInferenceProofModel, isAdvanced());
		...
		this.scrollPane.addComponentListener(new ComponentAdapter() {
			...
			{
				TypeInferenceView.this.component.setAvailableWidth(TypeInferenceView.this.scrollPane.getViewport()
						.getWidth());
			}
		});
		this.outline = new DefaultOutline(this);
		TypeFormula t = ((TypeInferenceProofNode) this.typeInferenceProofModel.getRoot().getLastLeaf())
				.getAllFormulas().get(0);
		if (t instanceof TypeJudgement)
		{
			TypeJudgement typeJudgement = (TypeJudgement) t;
			this.outline.load(typeJudgement.getExpression(), Outline.ExecuteInit.TYPEINFERENCE);
		}
