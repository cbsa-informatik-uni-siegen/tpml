 ...
 * {@link TypeInferenceRuleLabel}s showing the rules
...
public class TypeInferenceRulesComponent extends JComponent {
	...
	/**
	 * The list of {@link TypeInferenceRuleLabel}s containing the
	...
	/**
	 * After the layouting of the {@link TypeInferenceComponent} the size
	 * contains the actual size of this component.
	 */
	private Dimension													size;

	/**
	 * Create a new {@link TypeInferenceRulesComponent} for the
	 * given proofNode.<br>
	 * <br>
	 ...
	 * <br>
	 * The actual width comes directly from the {@link TypeInferenceComponent}
