...
public abstract class AbstractRenderer
{
  ...
  private static void setTheme ( Theme theme , Component reference )
  {
    ...
    AbstractRenderer.fontHeight = Math.max ( AbstractRenderer.expFontMetrics
        .getHeight ( ) , Math.max ( AbstractRenderer.keywordFontMetrics
        .getHeight ( ) , Math.max ( AbstractRenderer.constantFontMetrics
        .getHeight ( ) , Math.max ( AbstractRenderer.envFontMetrics
        .getHeight ( ) , AbstractRenderer.typeFontMetrics.getHeight ( ) ) ) ) ) ;
    AbstractRenderer.fontAscent = Math.max ( AbstractRenderer.expFontMetrics
        .getAscent ( ) , Math.max ( AbstractRenderer.keywordFontMetrics
        .getAscent ( ) , Math.max ( AbstractRenderer.constantFontMetrics
        .getAscent ( ) , Math.max ( AbstractRenderer.envFontMetrics
        .getAscent ( ) , AbstractRenderer.typeFontMetrics.getAscent ( ) ) ) ) ) ;
    AbstractRenderer.fontDescent = Math
        .max ( AbstractRenderer.expFontMetrics.getDescent ( ) , Math.max (
            AbstractRenderer.keywordFontMetrics.getDescent ( ) , Math.max (
