...
public class LabelComponent extends JComponent {
	...
	public Dimension getNeededSize ( int maxWidth ) {
		...
		result.width += AbstractRenderer.getTextFontMetrics ( ).stringWidth ( this.label.toString ( ) );
	...
	protected void paintComponent ( Graphics gc ) {
		...
		posX += AbstractRenderer.getTextFontMetrics ( ).stringWidth ( this.label.toString ( ) );
	}
