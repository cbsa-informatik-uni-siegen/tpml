#!/bin/sh
#
# $Id: tpml.sh 1926 2007-07-18 11:25:52Z benjamin $
#
...
<mime-info xmlns="http://www.freedesktop.org/standards/shared-mime-info">
  <mime-type type="text/x-tpml">
    ...
    <glob pattern="*.[Ll][1234][Ss][Uu][Bb][Tt][Yy][Pp][Ee]" />
    <glob pattern="*.[Ll]2[Oo][Ss][Uu][Bb][Tt][Yy][Pp][Ee]" />
    <glob pattern="*.[Ll]2[Cc][Ss][Uu][Bb][Tt][Yy][Pp][Ee]" />
  </mime-type>
</mime-info>
EOF
...
exec java -jar "$REALPATH/de.unisiegen.tpml.ui-1.2.0.jar" "$@"
