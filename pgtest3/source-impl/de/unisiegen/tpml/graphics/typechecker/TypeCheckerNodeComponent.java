...
public class TypeCheckerNodeComponent extends JComponent implements TreeNodeComponent {
	...
	public TypeCheckerNodeComponent ( TypeCheckerProofNode pNode, TypeCheckerProofModel model,
			LanguageTranslator translator, boolean advanced ) {
		super ( );
	...
	public void changeNode ( ) {
		if ( proofNode instanceof TypeCheckerExpressionProofNode ) {
			TypeCheckerExpressionProofNode expressionNode = ( TypeCheckerExpressionProofNode ) proofNode;
			...
			TypeCheckerTypeProofNode typeNode = ( TypeCheckerTypeProofNode ) proofNode;
		...
		if ( this.proofNode instanceof TypeCheckerExpressionProofNode ) {
			...
			if ( this.proofNode.isProven ( ) ) {
				...
				if ( !this.typeEnter.isActive ( ) ) {
					...
					this.ruleButton.setBounds ( posX, this.dimension.height + this.spacing, buttonSize.width,
							buttonSize.height );
