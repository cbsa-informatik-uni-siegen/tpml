 ...
 * in which the start and the end index of the {@link PrettyStyle}s is saved.
 * 
...
public abstract class OutlineStyle
{
   ...
   * index of the {@link PrettyStyle}s is saved. This method searches for
   * {@link PrettyStyle}s only to the beginning of the first child
   * {@link Expression}.
   * 
   ...
   *         index of the {@link PrettyStyle}s is saved.
   */
   ...
   * Returns a list of {@link OutlinePair}, in which the start and the end
   * index of the {@link PrettyStyle}s is saved. This method searches for
   * {@link PrettyStyle}s from the start to the end index.
   * 
   * @param pExpression The {@link Expression} in which the {@link PrettyStyle}s
   *          should be searched for.
   * @param pPrettyStyle
