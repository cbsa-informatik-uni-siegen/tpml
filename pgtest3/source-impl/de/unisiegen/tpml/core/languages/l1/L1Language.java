...
public class L1Language extends L0Language
{
  ...
  {
    return new BigStepProofModel ( expression , new L1BigStepProofRuleSet (
        this ) ) ;
  }
  ...
  {
    return new MinimalTypingProofModel ( expression , new L1MinimalTypingProofRuleSet(this, mode), mode);
  }
