 ...
 */
public abstract class AbstractTypeCheckerProofRule extends AbstractProofRule implements TypeCheckerProofRule {
	//
	// Constructor (package)
	//
	/**
	 ...
	 */
	protected abstract void applyInternal ( TypeCheckerProofContext context, TypeCheckerProofNode node )
			throws Exception;
	 ...
	 */
	protected abstract void updateInternal ( TypeCheckerProofContext context, TypeCheckerProofNode node )
			throws Exception;
}
