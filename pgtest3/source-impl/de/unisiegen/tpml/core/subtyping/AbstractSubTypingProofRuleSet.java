...
public abstract class AbstractSubTypingProofRuleSet extends
  ...
  protected void register(int group, String name, final Method applyMethod, final Method updateMethod) {
    ...
    register(new AbstractSubTypingProofRule(group, name) {
      @Override
      protected void applyInternal(SubTypingProofContext context, SubTypingProofNode node) throws Exception {
        applyMethod.invoke(AbstractSubTypingProofRuleSet.this, context, node);
      }
      @Override
      protected void updateInternal(SubTypingProofContext context, SubTypingProofNode node) throws Exception {
        if (updateMethod != null) {
          updateMethod.invoke(AbstractSubTypingProofRuleSet.this, context, node);
        }
      }
    });
  }
  ...
  private Method getMethodByName(String methodName) {
    ...
    try {
      ...
      return getClass().getMethod(methodName, new Class[] { SubTypingProofContext.class, SubTypingProofNode.class });
    }
