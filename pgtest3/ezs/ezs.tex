...
\begin{enumerate}
             ...
             in denen der Mensch Entlastung erfahren kann}{\pages{2}{4}}
  {
    ...
    \catchword{Arbeiten, die hohe Anforderungen an die Konzentration stellen. Mit wechsel von Zeiten hoher Aktivit"at und hoher Anforderung an die Aufmerksamkeit und Zeiten geringer Aktivit"at, die mit Langeweile ausgef"ullt sind.}
  ...
  \statement{Nennen Sie die Grenzen der Automatisierung}{\page{4}}
  {
    ...
    \catchword{Kleine Fehler k"onnen katastrophale Folgen haben}
  }

  \question{In welchen Bereichen ist die Erkenntnisf"ahigkeit des Menschen notwendig}{\page{4}}
  {
