...
\begin{enumerate}
  ...
  \question{Mit welchem Prozess ist ein Umformungsprozess fast immer gekoppelt}{\page{6}}
  {
  ...
  \statement{Geben Sie die Prozessgrößen an}{\page{11}}
  {
    ...
    \catchword{Prozess-Parameter}
    \catchword{Prozess-Zustand}
  ...
  \question{Was sind Prozesskennwerte}{\page{12}}
  {
  ...
  {
    \catchword{Gegenständliches Modell}
  ...
  {
    \catchword{Als statisches Modell, in dem die Prozessgrößen, Eingangs-, Ausgangs- und Zustandsgrößen
  ...
  {
    \catchword{Direkt: Der Operand folgt unmittelbar auf die Instruktion, der PC zeigt drauf}
  ...
  {
    \catchword{Aktuellen PC auf dem Stack ablegen}
  ...
  \question{Welche wesentlichen drei Aufgaben hat das Mikroprogramm}{\page{48}}
  {
    ...
    \catchword{Steuern der CPU d.h. des Datenverkehrs innerhalb der CPU, und insbesondere
               des Rechenwerks (ALU)}
  }
  ...
  {
    \catchword{Load-and-Store-Architektur bei RISC}
    \catchword{Pipelining (Einteilung in 5 Phasen: IF, RD, OP, MM, WT bei RISC)}
  }
  ...
  \question{Welche Messglieder gibt es und wie funktionieren sie}{\pages{195}{199}}
  {
    ...
    \catchword{Kapazitive und induktive Messverfahren \resultol{Kondensator wird deformiert und dadurch seine
               Kapazität geändert, oder eine Spuleninduktivität wird durch Einschieben eines Ferritkernes geändert.}}
  ...
  {
    \catchword{Nachteil: riesiger Aufwand: für $n$ Bits braucht man $2^n$ Widerstände und $(2^n)-1$ Umschalter}
  ...
  \statement{Beschreiben Sie den Zustand ruhend}{\page{290}}
  {
    \normaltext{Task ist vorhanden aber zur Zeit nicht zur Bearbeitung vorgesehen.
                ...
                kommen sie nach ihrer Beendigung aus dem Zustand \important{rechnend} oder nach
                ihrer Erstellung. Aus diesem Zustand kommt der Task in \important{bereit}, wenn
                er angefordert wird.}
  }
  ...
  \statement{Beschreiben Sie den Zustand bereit}{\page{291}}
  {
    \normaltext{Task besitzt alle benötigten Betriebsmittel außer der CPU. Taks befinden
                ...
                \important{rechnend} sind. Neben den aufgerufenen ruhenden Tasks kommen auch Tasks
                aus dem Zustand \important{rechnend} nach einem Interrupt oder aus dem Zustand 
                \important{wartend}, wenn ihnen alle benötigten Betribesmittel zur Verfügung
                gestellt wurden.}
  }
...
\statementnopage{Definieren Sie den Begriff Automatisierungsgrad}  
{
  ...
  Zapfsäulen (mit jeweils einem Standplatz) und einer Kasse als
  Petri-Netz}
  {
  \normaltext{siehe Übungen}
  }
