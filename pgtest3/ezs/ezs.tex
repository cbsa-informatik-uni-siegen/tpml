...
\statement{Beschreiben Sie den Zustand rechnend kurz}
  ...
  \question{Wie legt man den Automatisierungsgrad fest}
      {}
  {
  \normaltext{Abwägen: Kosten - Nutzen}
  }
  
  \question{Was bedeutet Durchsatz und in welchen 
  Eineheiten wird er gemessen}
      {}
  {
  \normaltext{Arbeitsmenge / Zeit, gemessen z.B. in 
  Stück / Tag, Tonne / Stunde, Liter / Minute}
  }
  
  \question{Wie ist Auslasung definidert und welchen 
  maximalen Wert kann sie erreichen, welcher Wert wäre 
  normal.}
      {}
  {
  \normaltext{Durchsatz / max Durchsatz, <1, typ: =0,9}
  }

\question{Was bedeutet Just In Time}
      {}
  {
  \normaltext{Es gibt keine Lagerhaltung, sie wird durch 
  den Transport ersetzt. Manch ein LKW fährt auf deutschen 
  Autobahnen als Lagerstelle rum.}
  }
  
  \question{Welche Vor / Nachteile hat Just in Time}
      {}
  {
  \normaltext{man spart Lagerkosten,
  Man ist abhängig vom Verkehrsaufkommen}
  }
  ...
  \question{Welche Kenngröße beschreibt die 
  Leistungsähigkeit für Datenübertragung}
      {}
  {
  \normaltext{das BAndbreiten - Längen - Produkt}
  }
  
  \question{Wie lauten typische Werte für zwei Leitungstypen}
      {}
  {
  \normaltext{Einzelader: 1MHz * m}
  \normaltext{Glasphaser: 1GHz * m}
  }
